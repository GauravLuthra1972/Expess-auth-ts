...
describe('getOptionValue', function () {
    it('returns for simple option', function () {
        var optionValue = getOptionValue({ test: 'text' }, 'test');
        expect(optionValue).toEqual('text');
    });
    it('returns for complex option', function () {
        var optionValue = getOptionValue({ test: { value: 'text' } }, 'test');
        var optionValue1 = getOptionValue({ test: { value: 'text' } }, 'test.value');
        var optionValue2 = getOptionValue({ test: { value: 'text' } }, 'test1.value');
    ...
    it('returns for collection option', function () {
        ...
        var optionValue1 = getOptionValue({ test: value }, 'test[1]');
        var optionValue2 = getOptionValue({ test: value }, 'test');
        var optionValue3 = getOptionValue({ test: value }, 'test[2].test[1]');
        var optionValue4 = getOptionValue({ test: value }, 'test[2].test');
        var optionValue5 = getOptionValue({ test: value }, 'test[2].test[0].option');
        var optionValue6 = getOptionValue({ test: value }, 'test[2].test[0].option.text');
    ...
    it('returns for empty', function () {
        var optionValue = getOptionValue({}, 'test');
        var optionValue2 = getOptionValue({ test: [{ text: 'value1' }] }, 'test[1]');
