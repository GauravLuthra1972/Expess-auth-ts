...
var text_box_1 = __importDefault(require("../../text-box"));
jest.setTimeout(1000);
beforeEach(function () {
    jest.clearAllMocks();
});
describe('two-way binding', function () {
    it('v-model works correctly', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var vm, wrapper, component;
        return __generator(this, function (_a) {
            vm = vue_1.defineComponent({
            ...
            wrapper = test_utils_1.mount(vm);
            component = wrapper.getComponent('#component2').vm;
    ...
    it('v-model with argument works correctly', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var vm, wrapper, component;
        return __generator(this, function (_a) {
            vm = vue_1.defineComponent({
