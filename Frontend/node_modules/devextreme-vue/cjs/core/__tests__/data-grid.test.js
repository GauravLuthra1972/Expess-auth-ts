...
describe('data grid', function () {
    it('vmodel should work correctly for nested components', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var vm, wrapper, instance;
        return __generator(this, function (_a) {
            ...
            instance = wrapper.getComponent('#grid').vm.$_instance;
