...
var TestComponent = index_1.createComponent({
...
function buildTestConfigCtor() {
    return index_1.createConfigurationComponent({
        props: {
            prop1: Number,
            prop2: String,
            sampleProp: String,
...
describe('component rendering', function () {
    ...
    it('calls widget creation', function () {
        test_utils_1.mount(TestComponent);
    ...
    it('creates nested component', function () {
        test_utils_1.mount(vue_1.defineComponent({
    ...
    describe('options', function () {
        ...
        it('watch prop changing', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wrapper = test_utils_1.mount(TestComponent, {
                            props: {
                                sampleProp: 'default',
                            },
                        });
        ...
        it('component shouldn\'t update array value(by default)', function (done) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        component = vue_1.defineComponent({
                        ...
                        wrapper = test_utils_1.mount(component);
        ...
        it('component updates array value if the deepWatch flag equal true', function (done) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config_1.default({ deepWatch: true });
                        component = vue_1.defineComponent({
                            template: "\n                    <button @click=\"testData.push(2)\">Click me</button>\n                    <test-component :prop2=\"testData\"></test-component>\n                ",
                            components: {
                                TestComponent: TestComponent,
                    ...
                    case 1:
                        ...
                        vue_1.nextTick(function () {
                            ...
                            config_1.default({ deepWatch: false });
                            done();
                        });
                        return [2 /*return*/];
                }
    ...
    describe('configuration', function () {
        ...
        describe('expectedChildren', function () {
            it('initialized for widget component', function () {
                var expected = {};
                var WidgetComponent = index_1.createComponent({
                    beforeCreate: function () {
                        this.$_WidgetClass = WidgetClass;
                        this.$_expectedChildren = expected;
                    },
                });
                var wrapper = test_utils_1.mount(WidgetComponent);
    ...
    describe('template', function () {
        ...
        var componentWithTemplate = vue_1.defineComponent({
        ...
        it('passes \'integrationOptions.templates\' on update', function () {
            var wrapper = test_utils_1.mount(componentWithTemplate);
            wrapper.setProps({
                renderTemplate: true,
            });
            vue_1.nextTick(function () {
        ...
        describe('with DOM', function () {
            ...
            it('template content should be rendered in DOM', function () {
                var mountedInDom;
                var ChildComponent = vue_1.defineComponent({
                    template: '<div>Test</div>',
                    mounted: function () {
                        mountedInDom = document.body.contains(this.$el);
                    },
                });
                var instance = vue_1.defineComponent({
                ...
                var wrapper = test_utils_1.mount(instance, { attachTo: document.getElementById('fixture') });
        ...
        it('template should have globalProperties of parent', function () {
            ...
            var CustomComponent = vue_1.defineComponent({
                template: '<div></div>',
                mounted: function () {
            ...
            // @ts-expect-error
            test_utils_1.mount(vm, { global: { config: config } });
            renderItemTemplate();
        ...
        describe('static items', function () {
            it('passes integrationOptions to widget', function () {
                var NestedItem = index_1.createConfigurationComponent({
                    props: {
                        prop1: Number,
                        template: String,
                    },
            ...
            it('passes configuration component updates before templates', function () {
                ...
                NestedItem.$_optionName = 'items';
                NestedItem.$_isCollectionItem = true;
                var component = vue_1.defineComponent({
                ...
                var wrapper = test_utils_1.mount(component);
                wrapper.setProps({
                    renderTemplate: true,
                    prop1Value: 2,
                });
            ...
            it('renders template containing text only (vue 3)', function () {
                ...
                var wrapper = vue_1.defineComponent({
    ...
    describe('extension component', function () {
        ...
        var TestExtensionComponent = index_1.createExtensionComponent({
            beforeCreate: function () {
        ...
        it('renders once if mounted manually and targets self element', function () {
            var component = test_utils_1.mount(TestExtensionComponent);
        ...
        it('should set extension flag when component mounted', function () {
            var getExtansionFlag = function (componentInstance) { return vue_helper_1.getNodeOptions(componentInstance).$_isExtension; };
...
describe('disposing', function () {
    it('call dispose', function () {
        var component = test_utils_1.mount(TestComponent);
        component.unmount();
...
describe('children processing', function () {
    it.skip('should process children if they are wrapped to a bail container', function () {
        var Nested = buildTestConfigCtor();
        var config = new configuration_1.default(function () { return undefined; }, null, {});
        Nested.$_optionName = 'nestedOption';
        var nestedVNode = vue_1.createVNode(Nested);
        var vnode = vue_1.renderSlot({ default: function () { return [nestedVNode]; } }, 'default', undefined, function () { return [vue_1.h('comment')]; });
        expect(vnode.patchFlag).toBe(-2 /* BAIL */);
        children_processing_1.pullConfigComponents([vnode], [], config);
