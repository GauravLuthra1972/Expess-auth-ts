...
export var dxBarGauge = BaseGauge.inherit({
    ...
    _renderContent: function() {
        ...
        if (context.textEnabled) {
            var _labelOptions, _labelOptions2, _labelOptions2$font;
            context.fontStyles = _patchFontOptions(_extend({}, this._themeManager.theme().label.font, null === (_labelOptions = labelOptions) || void 0 === _labelOptions ? void 0 : _labelOptions.font, {
                color: (null === (_labelOptions2 = labelOptions) || void 0 === _labelOptions2 ? void 0 : null === (_labelOptions2$font = _labelOptions2.font) || void 0 === _labelOptions2$font ? void 0 : _labelOptions2$font.color) || null
            }));
            ...
            var text = this._renderer.text(_getSampleText(this._translator, context.formatOptions), 0, 0).attr(context.textOptions).css(context.fontStyles).append(this._barsGroup);
...
_extend(BarWrapper.prototype, {
    ...
    arrange: function(options) {
        ...
        if (context.textEnabled) {
            ...
            this._text.css({
                fill: context.fontStyles.fill || this._color
            })
        }
        return this
    },
