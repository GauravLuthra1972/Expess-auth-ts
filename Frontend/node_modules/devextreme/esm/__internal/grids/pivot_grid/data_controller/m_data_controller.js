    ...
    var members = {
        ...
        getRowsInfo(getAllData) {
            ...
            if (scrollController && !getAllData) {
                ...
                var summaryFields = this._dataSource.getSummaryFields();
                var isRowDataFieldArea = "row" === this._options.dataFieldArea;
                var newRowsInfo = [];
                var maxDepth = 1;
                foreachRowInfo(rowsInfo, (rowInfo, visibleIndex, rowIndex, _, columnIndex) => {
                    ...
                    if (isVisible) {
                        ...
                        var isSummaryCell = summaryFields.some(field => field.caption === cell.text);
