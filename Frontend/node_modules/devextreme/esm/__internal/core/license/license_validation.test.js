...
describe("license token", () => {
    it.each([{
        ...
        var license = parseLicenseKey(token);
    ...
    it("verifies and decodes payload with extra fields", () => {
        var license = parseLicenseKey("ewogICJmb3JtYXQiOiAxLAogICJjdXN0b21lcklkIjogImIxMTQwYjQ2LWZkZTEtNDFiZC1hMjgwLTRkYjlmOGU3ZDliZCIsCiAgIm1heFZlcnNpb25BbGxvd2VkIjogMjMxLAogICJleHRyYUZpZWxkIjogIkE5OTk5OTkiCn0=.fqm8mVhQ9+x/R7E7MVwUP3nJaYL3KldhYffVXdDqPVyHIQi66Z2XZ2RdygH4J0jvUpjhZ6yzmGPV0J0WoPbKyhtnY4ELhove/IAwpn8WGfRw3wLSxfR+RWuaKcw2yvlUA1JqrQUrIrN23UwNQodbJ/hGm30s0h1bf8zCvQ/d31k=");
        expect(license.kind).toBe("verified");
        if ("verified" === license.kind) {
    ...
    it("fails if payload is invalid JSON", () => {
        var license = parseLicenseKey("YWJj.vjx6wAI9jVkHJAnKcsuYNZ5UvCq3UhypQ+0f+kZ37/Qc1uj4BM6//Kfi4SVsXGOaOTFYWgzesROnHCp3jZRqphJwal4yXHD1sGFi6FEdB4MgdgNZvsZSnxNWLs/7s07CzuHLTpJrAG7sTdHVkQWZNnSCKjzV7909c/Stl9+hkLo=");
        expect(license.kind).toBe("corrupted");
        if ("corrupted" === license.kind) {
    ...
    it.each(["", ".", "a", "a.", ".a", ".a.", ".a.", ".a.b", "a.b.", ".a.b."])("is not parsed from invalid input [%#]", invalidInput => {
        var license = parseLicenseKey(invalidInput);
        expect(license.kind).toBe("corrupted");
        if ("corrupted" === license.kind) {
...
describe("version mismatch", () => {
    ...
    test("Perform version comparison if the license is okay", () => {
        ...
        expect(null === errorsLogMock || void 0 === errorsLogMock ? void 0 : errorsLogMock.mock.calls.length).toEqual(1);
        expect(null === errorsLogMock || void 0 === errorsLogMock ? void 0 : errorsLogMock.mock.calls[0][0]).toEqual("W0023")
    });
    test.each([
        [
            [{
...
describe("license check", () => {
    ...
    test.each([{
        ...
        token: TOKEN_23_1,
        version: "123"
    }])("W0022 error should be logged if version is preview [%#]", _ref5 => {
        var {
            token: token,
            version: version
        } = _ref5;
    ...
    test.each([{
        ...
        token: TOKEN_23_2,
        version: "23.2.6"
    }])("No messages should be logged if license is valid", _ref6 => {
        var {
            token: token,
            version: version
        } = _ref6;
    ...
    test.each([{
        ...
        token: TOKEN_23_2,
        version: "42.4.5"
    }])("W0020 error should be logged if license is outdated", _ref7 => {
        var {
            token: token,
            version: version
        } = _ref7;
    ...
    test.each([{
        ...
        token: "3.2.1",
        version: "1.2.3"
    }])("W0021 error should be logged if license is corrupted/invalid [%#]", _ref8 => {
        var {
            token: token,
            version: version
        } = _ref8;
