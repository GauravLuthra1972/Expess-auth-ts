...
var TOAST_CLASS_PREFIX = "".concat(TOAST_CLASS, "-");
var TOAST_WRAPPER_CLASS = "".concat(TOAST_CLASS_PREFIX, "wrapper");
var TOAST_CONTENT_CLASS = "".concat(TOAST_CLASS_PREFIX, "content");
var TOAST_MESSAGE_CLASS = "".concat(TOAST_CLASS_PREFIX, "message");
var TOAST_ICON_CLASS = "".concat(TOAST_CLASS_PREFIX, "icon");
...
var Toast = Overlay.inherit({
    ...
    _toggleCloseEvents(event) {
        var dxEvent = "dx".concat(event.toLowerCase());
        eventsEngine.off(this.$content(), dxEvent);
        this.option("closeOn".concat(event)) && eventsEngine.on(this.$content(), dxEvent, this.hide.bind(this))
    },
    _posStringToObject() {
