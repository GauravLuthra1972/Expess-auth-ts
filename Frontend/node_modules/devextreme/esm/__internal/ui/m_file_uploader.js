...
class FileUploader extends Editor {
    ...
    _focusTarget() {
        return this.$element().find(".".concat(FILEUPLOADER_BUTTON_CLASS))
    }
    _getSubmitElement() {
    ...
    _updateFileNameMaxWidth() {
        ...
        var filesContainerWidth = getWidth(this._$filesContainer.find(".".concat(FILEUPLOADER_FILE_CONTAINER_CLASS)).first()) || getWidth(this._$filesContainer);
        var $buttonContainer = this._$filesContainer.find(".".concat(FILEUPLOADER_BUTTON_CONTAINER_CLASS)).eq(0);
        var buttonsWidth = getWidth($buttonContainer) * (cancelButtonsCount + uploadButtonsCount);
        var $fileSize = this._$filesContainer.find(".".concat(FILEUPLOADER_FILE_SIZE_CLASS)).eq(0);
        var prevFileSize = $fileSize.text();
        $fileSize.text("1000 Mb");
        var fileSizeWidth = getWidth($fileSize);
        $fileSize.text(prevFileSize);
        this._$filesContainer.find(".".concat(FILEUPLOADER_FILE_NAME_CLASS)).css("maxWidth", filesContainerWidth - buttonsWidth - fileSizeWidth)
    }
    ...
    _getCancelButton(file) {
        ...
        file.cancelButton = this._createComponent($("<div>").addClass("".concat(FILEUPLOADER_BUTTON_CLASS, " ").concat(FILEUPLOADER_CANCEL_BUTTON_CLASS)), Button, {
    ...
    _getUploadButton(file) {
        ...
        file.uploadButton = this._createComponent($("<div>").addClass("".concat(FILEUPLOADER_BUTTON_CLASS, " ").concat(FILEUPLOADER_UPLOAD_BUTTON_CLASS)), Button, {
