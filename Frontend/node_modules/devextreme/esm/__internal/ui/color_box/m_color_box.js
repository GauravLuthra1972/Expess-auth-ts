...
var COLOR_BOX_INPUT_CLASS = "".concat(COLOR_BOX_CLASS, "-input");
var COLOR_BOX_INPUT_CONTAINER_CLASS = "".concat(COLOR_BOX_INPUT_CLASS, "-container");
var COLOR_BOX_COLOR_RESULT_PREVIEW_CLASS = "".concat(COLOR_BOX_CLASS, "-color-result-preview");
var COLOR_BOX_COLOR_IS_NOT_DEFINED = "".concat(COLOR_BOX_CLASS, "-color-is-not-defined");
var COLOR_BOX_OVERLAY_CLASS = "".concat(COLOR_BOX_CLASS, "-overlay");
