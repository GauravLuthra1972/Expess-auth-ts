...
var TILEVIEW_ITEM_SELECTOR = ".".concat(TILEVIEW_ITEM_CLASS);
...
var TileView = CollectionWidget.inherit({
    ...
    _itemClass: () => TILEVIEW_ITEM_CLASS,
    _itemDataKey: () => TILEVIEW_ITEM_DATA_KEY,
    _itemContainer() {
    ...
    _renderGeometry() {
        ...
        var maxItemCrossRatio = Math.max.apply(Math, map(items || [], item => Math.round(item[config.itemCrossRatio] || 1)));
