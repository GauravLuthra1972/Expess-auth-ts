...
var RANGE_SLIDER_START_HANDLE_CLASS = "".concat(RANGE_SLIDER_CLASS, "-start-handle");
var RANGE_SLIDER_END_HANDLE_CLASS = "".concat(RANGE_SLIDER_CLASS, "-end-handle");
var RangeSlider = Slider.inherit({
    ...
    _updateSelectedRangePosition(leftRatio, rightRatio) {
        ...
        if (rtlEnabled ^ moveRight) {
            this._$range.css(prop, "".concat(100 - 100 * rightRatio, "%"))
        } else {
            this._$range.css(prop, "".concat(100 * leftRatio, "%"))
        }
    },
    ...
    _renderValue() {
        ...
        var startOffset = "".concat(parseFloat((100 * ratio1).toPrecision(12)), "%");
        var endOffset = "".concat(parseFloat((100 * (1 - ratio2)).toPrecision(12)), "%");
