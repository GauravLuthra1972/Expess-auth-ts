...
class RangeCalendarStrategy extends CalendarStrategy {
    ...
    supportedKeys() {
        var dateRangeBox = this.getDateRangeBox();
        return _extends(_extends({}, super.supportedKeys()), {
            rightArrow: () => {
            ...
            tab: e => {
                ...
                var $focusableElement = e.shiftKey ? dateRangeBox.getStartDateBox()._getLastPopupElement() : dateRangeBox.getStartDateBox()._getFirstPopupElement();
                if ($focusableElement) {
