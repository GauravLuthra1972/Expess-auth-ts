...
class MultiselectDateBox extends TypedDateBox {
    ...
    _processValueChange(e) {
        ...
        var dateRangeBox = this._getDateRangeBox();
        var [startDateInput, endDateInput] = dateRangeBox.field();
        ...
        var calendar = dateRangeBox.getStartDateBox().getStrategy().getWidget();
        var {
            value: value
        } = calendar.option();
        var startDate = getDeserializedDate(null === value || void 0 === value ? void 0 : value[0]);
        var endDate = getDeserializedDate(null === value || void 0 === value ? void 0 : value[1]);
        if ($(target).is($(startDateInput))) {
            if (startDate) {
    ...
    _isTargetOutOfComponent(target) {
        var $dateRangeBox = $(this._getDateRangeBox().element());
    ...
    _updateLabelWidth() {
        var $beforeButtonsContainer = this._getDateRangeBox()._$beforeButtonsContainer;
        var {
            labelMode: labelMode
        } = this.option();
    ...
    _optionChanged(args) {
        switch (args.name) {
            case "isValid":
                var isValid = this._getDateRangeBox().option("isValid");
