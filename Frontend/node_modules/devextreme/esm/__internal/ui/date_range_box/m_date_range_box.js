...
class DateRangeBox extends Editor {
    _getDefaultOptions() {
        ...
        return extend(super._getDefaultOptions(), {
            ...
            stylingMode: null !== (_a = config().editorStylingMode) && void 0 !== _a ? _a : "outlined",
    ...
    _defaultOptionsRules() {
        ...
        return super._defaultOptionsRules().concat([{
            ...
            options: {
                labelMode: "floating",
                stylingMode: null !== (_a = config().editorStylingMode) && void 0 !== _a ? _a : "filled"
            }
        }, {
            device() {
                var themeName = current();
    ...
    _hideOnOutsideClickHandler(_ref) {
        ...
        var $dropDownButton = null === dropDownButton || void 0 === dropDownButton ? void 0 : dropDownButton.$element();
    ...
    _optionChanged(args) {
        ...
        switch (name) {
            ...
            case "validationErrors":
                ...
                super._optionChanged(_extends(_extends({}, args), {
                    value: newValue
                }));
                break;
            case "value":
