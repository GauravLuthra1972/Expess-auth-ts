...
var ProgressBar = TrackBar.inherit({
    ...
    _renderIndeterminateState() {
        ...
        for (var i = 0; i < segments; i++) {
            $("<div>").addClass(PROGRESSBAR_INDETERMINATE_SEGMENT).addClass("".concat(PROGRESSBAR_INDETERMINATE_SEGMENT, "-").concat(i + 1)).appendTo(this._$segmentContainer)
        }
    ...
    _togglePositionClass() {
        ...
        var positionClass = "dx-position-".concat(splitPosition[0]);
        if (splitPosition[1]) {
