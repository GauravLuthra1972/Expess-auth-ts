...
var Slider = TrackBar.inherit({
    ...
    _renderHandleImpl(value, $element) {
        ...
        this.$element().toggleClass("".concat(SLIDER_TOOLTIP_POSITION_CLASS_PREFIX, "bottom"), tooltip.enabled && "bottom" === tooltip.position).toggleClass("".concat(SLIDER_TOOLTIP_POSITION_CLASS_PREFIX, "top"), tooltip.enabled && "top" === tooltip.position);
    ...
    _renderLabels() {
        this.$element().removeClass("".concat(SLIDER_LABEL_POSITION_CLASS_PREFIX, "bottom")).removeClass("".concat(SLIDER_LABEL_POSITION_CLASS_PREFIX, "top"));
    ...
    _updateHandlePosition(e) {
        ...
        setWidth(this._$range, "".concat(100 * newRatio, "%"));
    ...
    _getActualValue() {
        var _a;
        return null !== (_a = this._actualValue) && void 0 !== _a ? _a : this.option("value")
    },
