...
var Map = Widget.inherit({
    ...
    _renderShield() {
        ...
        if (this.option("disabled")) {
            ...
            $shield = this.$element().find(".".concat(MAP_SHIELD_CLASS));
            $shield.remove()
        }
    },
    _clean() {
    ...
    _optionChanged(args) {
        ...
        switch (name) {
            ...
            case "routes":
                ...
                this._queueAsyncAction("update".concat(titleize(name)), changeBag ? changeBag.removed : prevValue, changeBag ? changeBag.added : this._rendered[name]).then(result => {
                    if (changeBag) {
