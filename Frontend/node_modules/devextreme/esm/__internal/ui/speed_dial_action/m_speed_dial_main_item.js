...
class SpeedDialMainItem extends SpeedDialItem {
    ...
    _getCurrentOptions(actions) {
        var visibleActions = null === speedDialMainItem || void 0 === speedDialMainItem ? void 0 : speedDialMainItem._getVisibleActions(actions);
    ...
    _clickHandler() {
        ...
        if (null === (_a = config().floatingActionButtonConfig) || void 0 === _a ? void 0 : _a.shading) {
