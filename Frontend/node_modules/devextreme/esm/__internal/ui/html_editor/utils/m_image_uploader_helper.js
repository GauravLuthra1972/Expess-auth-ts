...
class UpdateUrlStrategy extends AddUrlStrategy {
    ...
    modifyFormData() {
        ...
        if (imgElement) {
            this.formData.width = null !== (_a = this.formData.width) && void 0 !== _a ? _a : getWidth($(imgElement));
            this.formData.height = null !== (_b = this.formData.height) && void 0 !== _b ? _b : getHeight($(imgElement))
        }
    }
    pasteImage(formData, event) {
    ...
    embedFormatIndex() {
        var _a;
        var selection = null !== (_a = this.selection) && void 0 !== _a ? _a : this.quill.getSelection();
        if (selection) {
            if (selection.length) {
