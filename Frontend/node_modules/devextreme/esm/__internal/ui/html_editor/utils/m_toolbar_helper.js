...
function prepareShowFormProperties(module, type) {
    return $element => {
        ...
        var [tableBlot, rowBlot] = null !== (_a = module.quill.getModule("table").getTable()) && void 0 !== _a ? _a : [];
...
function prepareLinkHandler(module) {
    return () => {
        ...
        var isCursorAtLink = void 0 !== formats.link && 0 === (null === selection || void 0 === selection ? void 0 : selection.length);
