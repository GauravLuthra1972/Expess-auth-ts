...
function getTableFormats(quill) {
    ...
    return (null === tableModule || void 0 === tableModule ? void 0 : tableModule.tableFormats) ? tableModule.tableFormats() : TABLE_FORMATS
}
...
function setLineElementsFormat(module, _ref2) {
    ...
    each(elements, (i, element) => {
        ...
        null === formatBlot || void 0 === formatBlot ? void 0 : formatBlot.format(fullPropertyName, "".concat(value, "px"))
    })
}
