...
var HtmlEditor = Editor.inherit({
    ...
    _shouldSkipFocusEvent: relatedTarget => $(relatedTarget).hasClass(QUILL_CLIPBOARD_CLASS),
    _initMarkup() {
    ...
    _prepareModuleOptions(args) {
        var _a;
        var optionData = null === (_a = args.fullName) || void 0 === _a ? void 0 : _a.split(".");
        var {
            value: value
        } = args;
        ...
        switch (args.name) {
            case "value":
                ...
                if (value !== args.previousValue) {
                    ...
                    this.callBase(_extends(_extends({}, args), {
                        value: value
                    }))
                }
                break;
    ...
    _applyToolbarMethod(methodName) {
        var _a;
        null === (_a = this.getModule("toolbar")) || void 0 === _a ? void 0 : _a[methodName]()
    },
