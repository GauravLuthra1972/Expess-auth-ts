...
export default class TableResizingModule extends BaseModule {
    ...
    _fixTablesWidths($tables) {
        each($tables, (index, table) => {
            ...
            if (0 === getAutoSizedElements($table).length) {
                ...
                var tableWidth = null !== (_a = this._tableLastWidth(frame)) && void 0 !== _a ? _a : getOuterWidth($table);
                if (frame) {
    ...
    _createResizeFrames($tables) {
        ...
        $tables.each((index, table) => {
            var _a;
            var $table = $(table);
            var $lastTable = null === (_a = this._tableResizeFrames[index]) || void 0 === _a ? void 0 : _a.$table;
