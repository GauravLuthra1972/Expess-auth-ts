...
if (Quill) {
    TableContextMenuModule = class extends BaseModule {
        ...
        _prepareMenuItemConfig(name) {
            var _a, _b;
            var iconName = null !== (_a = ICON_MAP[name]) && void 0 !== _a ? _a : name;
            var buttonText = titleize(name);
            return {
                text: localize(buttonText),
                icon: iconName.toLowerCase(),
                onClick: null !== (_b = this._formatHandlers[name]) && void 0 !== _b ? _b : getDefaultClickHandler(this, name)
            }
        }
        ...
        _getMenuConfig(items) {
            ...
            var customItems = this._prepareMenuItems((null === items || void 0 === items ? void 0 : items.length) ? items : defaultItems);
            return {
