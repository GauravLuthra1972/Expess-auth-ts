...
let GanttView = function(_Widget) {
    ...
    _proto._restoreVisualState = function(state) {
        if (state.fullScreen) {
    ...
    _proto.getVisualStateToRestore = function() {
        var _this$_ganttViewCore4;
        return {
            fullScreen: null === (_this$_ganttViewCore4 = this._ganttViewCore) || void 0 === _this$_ganttViewCore4 ? void 0 : _this$_ganttViewCore4.isInFullScreenMode()
        }
    };
