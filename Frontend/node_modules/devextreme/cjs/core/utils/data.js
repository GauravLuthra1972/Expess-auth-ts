...
const toComparable = function(value, caseSensitive) {
    ...
    if (!caseSensitive && "string" === typeof value) {
        ...
        const locale = null === options || void 0 === options ? void 0 : null === (_options$locale = options.locale) || void 0 === _options$locale ? void 0 : _options$locale.toLowerCase();
        const useUpperCase = locale && !!["hy", "el"].find(code => locale === code || locale.startsWith("".concat(code, "-")));
