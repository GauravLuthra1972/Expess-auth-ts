...
const DropDownList = _m_drop_down_editor.default.inherit({
    ...
    _updateActiveDescendant($target) {
        ...
        const listFocusedItemId = null === (_a = this._list) || void 0 === _a ? void 0 : _a.getFocusedItemId();
    ...
    _renderList() {
        this._listId = "dx-".concat((new _guid.default)._value);
    ...
    _getSearchEvent() {
        return (0, _index.addNamespace)("input", "".concat(this.NAME, "Search"))
    },
    _getCompositionStartEvent() {
        return (0, _index.addNamespace)("compositionstart", "".concat(this.NAME, "CompositionStart"))
    },
    _getCompositionEndEvent() {
        return (0, _index.addNamespace)("compositionend", "".concat(this.NAME, "CompositionEnd"))
    },
    _getSetFocusPolicyEvent() {
        return (0, _index.addNamespace)("input", "".concat(this.NAME, "FocusPolicy"))
    },
    _renderEvents() {
        this.callBase();
