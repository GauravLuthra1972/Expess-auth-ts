...
let BaseMaskRule = function() {
    ...
    _proto.isAccepted = function(caret) {
        return false
    };
    ...
    _proto._adjustedForward = function(caret, index, char) {};
    _proto._adjustedBackward = function(caret, index, char) {};
    _proto.isValid = function(args) {};
    _proto.reset = function() {};
    _proto.clear = function(args) {};
    _proto.text = function() {};
    _proto.value = function() {};
    _proto.rawValue = function() {};
    _proto.handle = function(args) {};
    return BaseMaskRule
}();
