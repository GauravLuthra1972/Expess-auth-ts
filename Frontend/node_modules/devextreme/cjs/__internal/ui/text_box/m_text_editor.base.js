...
exports.TEXTEDITOR_CLASS = "dx-texteditor";
const TEXTEDITOR_INPUT_CONTAINER_CLASS = "dx-texteditor-input-container";
const TEXTEDITOR_INPUT_CLASS = "dx-texteditor-input";
exports.TEXTEDITOR_INPUT_CLASS = "dx-texteditor-input";
const TEXTEDITOR_INPUT_SELECTOR = ".".concat("dx-texteditor-input");
...
const TextEditorBase = _editor.default.inherit({
    ...
    _buttonsContainer() {
        return this._inputWrapper().find(".".concat("dx-texteditor-buttons-container")).eq(0)
    },
    ...
    _setFieldAria(force) {
        ...
        const labelId = null === (_a = this._label) || void 0 === _a ? void 0 : _a.getId();
    ...
    _renderEvents() {
        ...
        (0, _iterator.each)(EVENTS_LIST, (_, event) => {
            if (this.hasActionSubscription("on".concat(event))) {
                const action = this._createActionByOption("on".concat(event), {
