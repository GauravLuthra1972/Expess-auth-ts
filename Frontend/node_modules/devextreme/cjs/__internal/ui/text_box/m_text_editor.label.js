...
let TextEditorLabel = function() {
    ...
    _proto._updateBeforeWidth = function() {
        var _a;
        if (this._isVisible()) {
            const width = null !== (_a = this._props.beforeWidth) && void 0 !== _a ? _a : this._props.getBeforeWidth();
            this._$before.css({
                width: width
            });
    ...
    _proto._updateMaxWidth = function() {
        var _a;
        if (this._isVisible() && !this._isOutsideMode()) {
            const maxWidth = null !== (_a = this._props.containerWidth) && void 0 !== _a ? _a : this._props.getContainerWidth();
            this._$label.css({
                maxWidth: maxWidth
            })
        }
