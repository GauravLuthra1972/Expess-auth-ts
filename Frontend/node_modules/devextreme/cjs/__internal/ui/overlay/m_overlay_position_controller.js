...
let OverlayPositionController = function() {
    ...
    _proto._renderBoundaryOffset = function() {
        var _a;
        const boundaryOffset = null !== (_a = this._position) && void 0 !== _a ? _a : {
    ...
    _proto._getVisualContainer = function() {
        ...
        const positionOf = (0, _type.isEvent)(null === (_a = this._props.position) || void 0 === _a ? void 0 : _a.of) ? this._props.position.of.target : null === (_b = this._props.position) || void 0 === _b ? void 0 : _b.of;
