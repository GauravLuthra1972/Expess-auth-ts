...
const Overlay = _ui2.default.inherit({
    ...
    _animateShowing() {
        var _this3 = this;
        var _a, _b, _c;
        const animation = null !== (_a = this._getAnimationConfig()) && void 0 !== _a ? _a : {};
        const showAnimation = this._normalizeAnimation(animation.show, "to");
        const startShowAnimation = null !== (_b = null === showAnimation || void 0 === showAnimation ? void 0 : showAnimation.start) && void 0 !== _b ? _b : _common.noop;
        const completeShowAnimation = null !== (_c = null === showAnimation || void 0 === showAnimation ? void 0 : showAnimation.complete) && void 0 !== _c ? _c : _common.noop;
    ...
    _animateHiding() {
        ...
        const startHideAnimation = null !== (_b = null === hideAnimation || void 0 === hideAnimation ? void 0 : hideAnimation.start) && void 0 !== _b ? _b : _common.noop;
        const completeHideAnimation = null !== (_c = null === hideAnimation || void 0 === hideAnimation ? void 0 : hideAnimation.complete) && void 0 !== _c ? _c : _common.noop;
