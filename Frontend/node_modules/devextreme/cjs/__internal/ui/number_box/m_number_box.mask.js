...
const NumberBoxMask = _m_number_box.default.inherit({
    ...
    _removeStubs(text, excludeComma) {
        ...
        if (stubs.length) {
            ...
            const postfixRegex = new RegExp("(".concat((0, _common.escapeRegExp)(stubs[1] || ""), ")$"), "g");
            const decoratorsRegex = new RegExp("[-".concat((0, _common.escapeRegExp)(excludeComma ? "" : thousandsSeparator), "]"), "g");
    ...
    _detachFormatterEvents() {
        _events_engine.default.off(this._input(), ".".concat("dxNumberFormatter"))
    },
    _isInputFromPaste(e) {
    ...
    _isStub(str, isString) {
        ...
        const regExpString = "^[^0-9".concat(escapedDecimalSeparator, "]+$");
