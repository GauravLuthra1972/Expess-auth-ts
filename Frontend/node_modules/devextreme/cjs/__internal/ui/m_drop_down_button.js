...
const DropDownButton = _ui2.default.inherit({
    ...
    _getKey() {
        ...
        const storeKey = null === (_a = this._dataSource) || void 0 === _a ? void 0 : _a.key();
    ...
    _renderPopupContent() {
        ...
        $content.empty();
        this._popupContentId = "dx-".concat(new _guid.default);
    ...
    _setButtonsAria(value) {
        ...
        this._getButtons().each((index, $button) => {
            if (0 === index) {
                this.setAria(_extends(_extends({}, firstButtonAria), commonButtonAria), (0, _renderer.default)($button))
            } else {
