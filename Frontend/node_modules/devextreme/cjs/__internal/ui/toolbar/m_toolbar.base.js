...
let ToolbarBase = function(_AsyncCollectionWidge) {
            ...
            if ((0, _type.isPlainObject)(data)) {
                ...
                if ("dxButton" === widget) {
                    if (this.option("useFlatButtons")) {
                        ...
                        data.options.stylingMode = null !== (_c = data.options.stylingMode) && void 0 !== _c ? _c : "text"
                    }
                    if (this.option("useDefaultButtons")) {
                        data.options = null !== (_d = data.options) && void 0 !== _d ? _d : {};
                        data.options.type = null !== (_e = data.options.type) && void 0 !== _e ? _e : "default"
                    }
                }
            } else {
    ...
    _proto._getDefaultOptions = function() {
        return _extends(_extends({}, _AsyncCollectionWidge.prototype._getDefaultOptions.call(this)), {
            renderAs: "topToolbar",
            grouped: false,
    ...
    _proto._arrangeItems = function(width) {
        var _a, _b;
        const elementWidth = null !== width && void 0 !== width ? width : (0, _size.getWidth)(this.$element());
        this._$centerSection.css({
            margin: "0 auto",
            float: "none"
        });
        const beforeRect = (0, _position.getBoundingRect)(null === (_a = this._$beforeSection) || void 0 === _a ? void 0 : _a.get(0));
        const afterRect = (0, _position.getBoundingRect)(null === (_b = this._$afterSection) || void 0 === _b ? void 0 : _b.get(0));
        ...
        $section.children().not(".".concat("dx-toolbar-label")).each((index, element) => {
    ...
    _proto._alignCenterSection = function(beforeRect, afterRect, elementWidth) {
        ...
        const centerRect = (0, _position.getBoundingRect)(null === (_a = this._$centerSection) || void 0 === _a ? void 0 : _a.get(0));
    ...
    _proto._renderItem = function(index, item, itemContainer, $after) {
        var _a, _b;
        const location = null !== (_a = item.location) && void 0 !== _a ? _a : "center";
        const container = null !== itemContainer && void 0 !== itemContainer ? itemContainer : this["_$".concat(location, "Section")];
        const itemHasText = !!(null !== (_b = item.text) && void 0 !== _b ? _b : item.html);
    ...
    _proto._renderGroupedItems = function() {
        (0, _iterator.each)(this.option("items"), (groupIndex, group) => {
            ...
            const location = null !== (_a = group.location) && void 0 !== _a ? _a : "center";
    ...
    _proto._itemOptionChanged = function(item, property, value, prevValue) {
        _AsyncCollectionWidge.prototype._itemOptionChanged.call(this, item, property, value, prevValue);
        this._arrangeItems()
    };
    _proto._optionChanged = function(args) {
        ...
        switch (name) {
            case "width":
                _AsyncCollectionWidge.prototype._optionChanged.call(this, args);
