...
let SingleLineStrategy = function() {
    ...
    _proto._getToolbarItems = function() {
        var _a;
        return (0, _common.grep)(null !== (_a = this._toolbar.option("items")) && void 0 !== _a ? _a : [], item => !this._toolbar._isMenuItem(item))
    };
    ...
    _proto._getMenuItems = function() {
        var _a, _b;
        const menuItems = (0, _common.grep)(null !== (_a = this._toolbar.option("items")) && void 0 !== _a ? _a : [], item => this._toolbar._isMenuItem(item));
    ...
    _proto._arrangeItems = function() {
        ...
        (0, _iterator.each)(null !== (_a = this._restoreItems) && void 0 !== _a ? _a : [], (_, obj) => {
    ...
    _proto._hideOverflowItems = function(width) {
        const overflowItems = this._toolbar.$element().find(".".concat("dx-toolbar-item-auto-hide"));
        if (!overflowItems.length) {
            return
        }
        const elementWidth = null !== width && void 0 !== width ? width : (0, _size.getWidth)(this._toolbar.$element());
