...
function toggleItemFocusableElementTabIndex(context, item) {
    ...
    const isItemNotFocusable = !!((null === (_a = itemData.options) || void 0 === _a ? void 0 : _a.disabled) || itemData.disabled || context.option("disabled"));
    const {
        widget: widget
    } = itemData;
    if (widget && TOOLBAR_ITEMS.includes(widget)) {
        ...
        if ($widget.length) {
            ...
            let $focusTarget = null === (_b = itemInstance._focusTarget) || void 0 === _b ? void 0 : _b.call(itemInstance);
            if ("dxDropDownButton" === widget) {
                $focusTarget = $focusTarget && $focusTarget.find(".".concat("dx-buttongroup"))
            } else {
                $focusTarget = null !== $focusTarget && void 0 !== $focusTarget ? $focusTarget : (0, _renderer.default)(itemInstance.element())
            }
            const tabIndex = null === (_c = itemData.options) || void 0 === _c ? void 0 : _c.tabIndex;
