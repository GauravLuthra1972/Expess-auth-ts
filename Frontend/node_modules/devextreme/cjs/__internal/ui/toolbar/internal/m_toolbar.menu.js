...
let DropDownMenu = function(_Widget) {
    ...
    _proto._getDefaultOptions = function() {
        return _extends(_extends({}, _Widget.prototype._getDefaultOptions.call(this)), {
            items: [],
            onItemClick: null,
            dataSource: null,
            itemTemplate: "item",
    ...
    _proto._toggleMenuVisibility = function(opened) {
        var _a, _b;
        const state = null !== opened && void 0 !== opened ? opened : !(null === (_a = this._popup) || void 0 === _a ? void 0 : _a.option("visible"));
        if (opened) {
            this._renderPopup()
        }
