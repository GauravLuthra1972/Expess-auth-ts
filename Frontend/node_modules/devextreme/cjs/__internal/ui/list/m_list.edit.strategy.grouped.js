...
const GroupedEditStrategy = _m_collection_widgetEditStrategy.default.inherit({
    _groupElements() {
        return this._collectionWidget._itemContainer().find(".".concat("dx-list-group"))
    },
    _groupItemElements: $group => $group.find(".".concat("dx-list-item")),
    ...
    _getNormalizedItemIndex(itemElement) {
        ...
        const $group = $item.closest(".".concat("dx-list-group"));
        if (!$group.length) {
            return -1
        }
        return combineIndex({
