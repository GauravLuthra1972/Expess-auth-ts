...
const ListItem = _m_item.default.inherit({
    ...
    _renderBadge(badge) {
        this._$element.children(".".concat("dx-list-item-badge-container")).remove();
        if (!badge) {
            return
        }
        ...
        const $chevron = this._$element.children(".".concat("dx-list-item-chevron-container")).first();
        $chevron.length > 0 ? $badge.insertBefore($chevron) : $badge.appendTo(this._$element)
    },
    _renderShowChevron(showChevron) {
        this._$element.children(".".concat("dx-list-item-chevron-container")).remove();
        if (!showChevron) {
            return
        }
