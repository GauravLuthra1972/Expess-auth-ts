...
const LIST_ITEM_SELECTOR = ".".concat("dx-list-item");
...
const ListBase = _uiCollection_widget.default.inherit({
    ...
    _refreshItemElements() {
        if (!this.option("grouped")) {
            ...
            this._itemElementsCache = this._getItemsContainer().children(".".concat("dx-list-group")).children(".".concat("dx-list-group-body")).children(this._itemSelector())
        }
    },
    _modifyByChanges() {
    ...
    _shouldContinueLoading(shouldLoadNextPage) {
        var _a, _b;
        const isBottomReached = (0, _size.getHeight)(this._scrollView.content()) - (0, _size.getHeight)(this._scrollView.container()) < (null !== (_b = null === (_a = this._scrollView.scrollOffset()) || void 0 === _a ? void 0 : _a.top) && void 0 !== _b ? _b : 0);
    ...
    _attachGroupCollapseEvent() {
        ...
        const selector = ".".concat("dx-list-group-header");
            ...
            _events_engine.default.on($element, eventName, selector, e => {
                this._createAction(e => {
                    ...
                    if (this.option("focusStateEnabled")) {
                        this.option("focusedElement", (0, _element.getPublicElement)($group.find(".".concat("dx-list-item")).eq(0)))
                    }
                }, {
    ...
    _collapseGroupHandler($group, toggle) {
        ...
        const $groupBody = $group.children(".".concat("dx-list-group-body"));
    ...
    _setListAria() {
        ...
        const listArea = (null === items || void 0 === items ? void 0 : items.length) ? {
            role: "listbox",
            label: "Items"
        } : {
            role: void 0,
    ...
    _extendActionArgs($itemElement) {
        ...
        const $group = $itemElement.closest(".".concat("dx-list-group"));
        const $item = $group.find(".".concat("dx-list-item"));
