...
exports.POPUP_CONTENT_SCROLLABLE_CLASS = "dx-popup-content-scrollable";
...
exports.TEMPLATE_WRAPPER_CLASS = "dx-template-wrapper";
...
const Popup = _ui.default.inherit({
    ...
    _doesShowAnimationChangeDimensions() {
        ...
        return ["to", "from"].some(prop => {
            var _a;
            const config = null === (_a = null === animation || void 0 === animation ? void 0 : animation.show) || void 0 === _a ? void 0 : _a[prop];
    ...
    _areContentDimensionsRendered(entry) {
        var _a, _b, _c, _d, _e;
        const contentBox = null === (_a = entry.contentBoxSize) || void 0 === _a ? void 0 : _a[0];
        if (contentBox) {
    ...
    _toggleAriaLabel() {
        ...
        null === (_a = this._$title) || void 0 === _a ? void 0 : _a.find(".".concat("dx-toolbar-label")).eq(0).attr("id", titleId);
    ...
    _getToolbarItemByAlias(data) {
        ...
        const itemClass = "".concat("dx-popup", "-").concat(itemType);
    ...
    _toggleClasses() {
        ...
        (0, _iterator.each)(aliases, (_, alias) => {
            const className = "".concat("dx-popup", "-").concat(alias);
    ...
    _renderGeometry(options) {
        ...
        if (visible && (0, _window.hasWindow)()) {
            ...
            const shouldRepeatAnimation = isAnimated && !(null === options || void 0 === options ? void 0 : options.forceStopAnimation) && useResizeObserver;
