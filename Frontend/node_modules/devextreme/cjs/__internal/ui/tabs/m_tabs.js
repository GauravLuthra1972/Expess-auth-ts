...
const Tabs = _uiCollection_widget.default.inherit({
    _activeStateUnit: ".".concat("dx-tab"),
    _getDefaultOptions() {
    ...
    _updateNavButtonsState() {
        ...
        const scrollable = this.getScrollable();
        if (isVertical) {
            null === (_a = this._leftButton) || void 0 === _a ? void 0 : _a.option("disabled", (0, _get_boundary_props.isReachedTop)(scrollable.scrollTop(), 1));
            null === (_b = this._rightButton) || void 0 === _b ? void 0 : _b.option("disabled", (0, _get_boundary_props.isReachedBottom)((0, _renderer.default)(scrollable.container()).get(0), scrollable.scrollTop(), 0, 1))
        } else {
            null === (_c = this._leftButton) || void 0 === _c ? void 0 : _c.option("disabled", (0, _get_boundary_props.isReachedLeft)(scrollable.scrollLeft(), 1));
            null === (_d = this._rightButton) || void 0 === _d ? void 0 : _d.option("disabled", (0, _get_boundary_props.isReachedRight)((0, _renderer.default)(scrollable.container()).get(0), scrollable.scrollLeft(), 1))
        }
    },
    ...
    _toggleStylingModeClass(value) {
        var _a;
        const newClass = null !== (_a = TABS_STYLING_MODE_CLASS[value]) && void 0 !== _a ? _a : TABS_STYLING_MODE_CLASS.primary;
