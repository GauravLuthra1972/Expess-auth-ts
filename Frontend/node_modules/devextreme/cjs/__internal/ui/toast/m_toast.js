...
const TOAST_CLASS_PREFIX = "".concat("dx-toast", "-");
const TOAST_WRAPPER_CLASS = "".concat(TOAST_CLASS_PREFIX, "wrapper");
const TOAST_CONTENT_CLASS = "".concat(TOAST_CLASS_PREFIX, "content");
const TOAST_MESSAGE_CLASS = "".concat(TOAST_CLASS_PREFIX, "message");
const TOAST_ICON_CLASS = "".concat(TOAST_CLASS_PREFIX, "icon");
...
const Toast = _ui.default.inherit({
    ...
    _toggleCloseEvents(event) {
        const dxEvent = "dx".concat(event.toLowerCase());
        _events_engine.default.off(this.$content(), dxEvent);
        this.option("closeOn".concat(event)) && _events_engine.default.on(this.$content(), dxEvent, this.hide.bind(this))
    },
    _posStringToObject() {
        ...
        switch (horizontalPosition) {
            ...
            case "left":
            case "right":
                this.option("position").at += " ".concat(horizontalPosition);
                this.option("position").my += " ".concat(horizontalPosition)
        }
    },
    _show() {
