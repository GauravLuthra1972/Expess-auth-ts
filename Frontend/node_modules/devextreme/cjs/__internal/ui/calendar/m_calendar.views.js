...
const Views = {
    month: _m_calendar.default.inherit({
        ...
        getCellAriaLabel: date => _date2.default.format(date, "longdate"),
        _renderHeader() {
    ...
    year: _m_calendar.default.inherit({
        ...
        getCellAriaLabel: date => _date2.default.format(date, "monthandyear"),
        getNavigatorCaption() {
    ...
    decade: _m_calendar.default.inherit({
        ...
        getNavigatorCaption() {
            ...
            return "".concat(_date2.default.format(startDate, "yyyy"), "-").concat(_date2.default.format(endDate, "yyyy"))
        },
    ...
    century: _m_calendar.default.inherit({
        ...
        _getCellText(cellDate) {
            ...
            return "".concat(startDate, " - ").concat(_date2.default.format(endDate, "yyyy"))
        },
        _getFirstCellData() {
