...
const Calendar = _editor.default.inherit({
    _activeStateUnit: ".".concat("dx-calendar-cell"),
    _getDefaultOptions() {
    ...
    _initCurrentDate() {
        var _a;
        const currentDate = null !== (_a = this._getNormalizedDate(this._selectionStrategy.getDefaultCurrentDate())) && void 0 !== _a ? _a : this._getNormalizedDate(this.option("currentDate"));
        this.option("currentDate", currentDate)
    },
    ...
    _renderViews() {
        this.$element().addClass("".concat("dx-calendar-view", "-").concat(this.option("zoomLevel")));
        const {
    ...
    _viewConfig(date) {
        ...
        return _extends(_extends({}, this._selectionStrategy.getViewOptions()), {
            ...
            firstDayOfWeek: null !== (_a = this.option("firstDayOfWeek")) && void 0 !== _a ? _a : _date2.default.firstDayOfWeekIndex(),
    ...
    _optionChanged(args) {
        ...
        switch (args.name) {
            ...
            case "currentDate":
                ...
                break;
            case "zoomLevel":
                this.$element().removeClass("".concat("dx-calendar-view", "-").concat(previousValue));
                this._correctZoomLevel();
                this._refreshViews();
                this._renderNavigator();
                this._updateAriaId();
