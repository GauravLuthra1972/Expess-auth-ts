...
let BING_URL_V8 = "https://www.bing.com/api/maps/mapcontrol?callback=".concat(BING_MAP_READY);
    ...
    _renderRoute(options) {
        return Promise.all((0, _iterator.map)(options.locations, point => this._resolveLocation(point))).then(locations => new Promise(resolve => {
            ...
            directionHandlers.push(Microsoft.Maps.Events.addHandler(direction, "directionsError", args => {
                ...
                const status = "RouteResponseCode: ".concat(args.responseCode, " - ").concat(args.message);
