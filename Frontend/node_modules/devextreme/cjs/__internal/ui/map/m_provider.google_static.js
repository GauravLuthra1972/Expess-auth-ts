...
const GoogleStaticProvider = _m_provider.default.inherit({
    ...
    _updateMap() {
        ...
        const requestOptions = ["sensor=false", "size=".concat(Math.round((0, _size.getWidth)($container)), "x").concat(Math.round((0, _size.getHeight)($container))), "maptype=".concat(this._option("type")), "center=".concat(this._locationToString(this._option("center"))), "zoom=".concat(this._option("zoom")), this._markersSubstring()];
