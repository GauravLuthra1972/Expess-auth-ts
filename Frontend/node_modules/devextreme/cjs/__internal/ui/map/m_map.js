...
const Map = _ui2.default.inherit({
    ...
    _renderShield() {
        ...
        if (this.option("disabled")) {
            ...
            $shield = this.$element().find(".".concat("dx-map-shield"));
            $shield.remove()
        }
    },
    _clean() {
    ...
    _optionChanged(args) {
        ...
        switch (name) {
            ...
            case "routes": {
                ...
                this._queueAsyncAction("update".concat((0, _inflector.titleize)(name)), changeBag ? changeBag.removed : prevValue, changeBag ? changeBag.added : this._rendered[name]).then(result => {
                    if (changeBag) {
