...
const COLOR_BOX_INPUT_CLASS = "".concat("dx-colorbox", "-input");
const COLOR_BOX_INPUT_CONTAINER_CLASS = "".concat(COLOR_BOX_INPUT_CLASS, "-container");
const COLOR_BOX_COLOR_RESULT_PREVIEW_CLASS = "".concat("dx-colorbox", "-color-result-preview");
const COLOR_BOX_COLOR_IS_NOT_DEFINED = "".concat("dx-colorbox", "-color-is-not-defined");
const COLOR_BOX_OVERLAY_CLASS = "".concat("dx-colorbox", "-overlay");
