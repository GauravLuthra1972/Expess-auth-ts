...
const Scrollable = _dom_component.default.inherit({
    ...
    _attachEventHandlers() {
        ...
        _events_engine.default.off(this._$wrapper, ".".concat(SCROLLABLE));
        ...
        _events_engine.default.off(this._$container, ".".concat(SCROLLABLE));
    ...
    scrollToElement(element, offset) {
        ...
        const elementIsInsideContent = $element.parents(".".concat("dx-scrollable")).length - $element.parents(".".concat("dx-scrollable-content")).length === 0;
