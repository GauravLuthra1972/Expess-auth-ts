...
const SCROLLVIEW_CONTENT_CLASS = "".concat("dx-scrollview", "-content");
const SCROLLVIEW_TOP_POCKET_CLASS = "".concat("dx-scrollview", "-top-pocket");
const SCROLLVIEW_BOTTOM_POCKET_CLASS = "".concat("dx-scrollview", "-bottom-pocket");
const SCROLLVIEW_PULLDOWN_CLASS = "".concat("dx-scrollview", "-pull-down");
const SCROLLVIEW_REACHBOTTOM_CLASS = "".concat("dx-scrollview", "-scrollbottom");
const SCROLLVIEW_REACHBOTTOM_INDICATOR_CLASS = "".concat(SCROLLVIEW_REACHBOTTOM_CLASS, "-indicator");
const SCROLLVIEW_REACHBOTTOM_TEXT_CLASS = "".concat(SCROLLVIEW_REACHBOTTOM_CLASS, "-text");
const SCROLLVIEW_LOADPANEL = "".concat("dx-scrollview", "-loadpanel");
