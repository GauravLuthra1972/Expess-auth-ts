...
const NativeStrategy = _class.default.inherit({
    ...
    render() {
        ...
        this._$element.addClass("dx-scrollable-native").addClass("".concat("dx-scrollable-native", "-").concat(deviceType)).toggleClass(SCROLLABLE_SCROLLBARS_HIDDEN, !this._isScrollbarVisible());
    ...
    dispose() {
        ...
        const scrollableNativeRegexp = new RegExp("".concat("dx-scrollable-native", "\\S*"), "g");
        if (scrollableNativeRegexp.test(className)) {
            this._$element.removeClass(className.match(scrollableNativeRegexp).join(" "))
        }
        _events_engine.default.off(this._$element, ".".concat(SCROLLABLE_NATIVE));
        _events_engine.default.off(this._$container, ".".concat(SCROLLABLE_NATIVE));
