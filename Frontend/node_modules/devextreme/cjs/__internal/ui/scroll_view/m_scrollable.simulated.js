...
const SCROLLABLE_SIMULATED_CURSOR = "".concat(SCROLLABLE_SIMULATED, "Cursor");
const SCROLLABLE_SIMULATED_KEYBOARD = "".concat(SCROLLABLE_SIMULATED, "Keyboard");
...
const Scroller = _class.default.inherit({
    ...
    _getBaseDimension(element, dimension) {
        const dimensionName = "offset".concat((0, _inflector.titleize)(dimension));
    ...
    _moveToMouseLocation(e) {
        const mouseLocation = e["page".concat(this._axis.toUpperCase())] - this._$element.offset()[this._prop];
    ...
    _contentSize() {
        const isOverflowHidden = "hidden" === this._$content.css("overflow".concat(this._axis.toUpperCase()));
        let contentSize = this._getRealDimension(this._$content.get(0), this._dimension);
        if (!isOverflowHidden) {
            const containerScrollSize = this._$content[0]["scroll".concat((0, _inflector.titleize)(this._dimension))] * this._getScaleRatio();
...
const SimulatedStrategy = _class.default.inherit({
    ...
    _eventHandler(eventName) {
        ...
        const deferreds = (0, _iterator.map)(this._scrollers, scroller => scroller["_".concat(eventName, "Handler")].apply(scroller, args));
