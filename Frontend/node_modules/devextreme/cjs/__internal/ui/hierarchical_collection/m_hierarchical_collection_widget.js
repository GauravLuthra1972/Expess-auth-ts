...
const HierarchicalCollectionWidget = _uiCollection_widget.default.inherit({
    ...
    _getLinkContainer(iconContainer, textContainer, _ref) {
        ...
        return (0, _renderer.default)("<a>").addClass("dx-item-url").attr(_extends(_extends({}, linkAttributes), {
            href: url
    ...
    _getIconContainer(itemData) {
        ...
        if ($imageContainer.is("img")) {
            const componentName = this.NAME.startsWith("dxPrivateComponent") ? "" : "".concat(this.NAME, " ");
    ...
    _compileAccessor(optionName) {
        const getter = "_".concat(optionName, "Getter");
        const setter = "_".concat(optionName, "Setter");
        const optionExpr = this.option("".concat(optionName, "Expr"));
        if (!optionExpr) {
    ...
    _createDataAdapterAccessors() {
        ...
        (0, _iterator.each)(this._getAccessors(), (_, accessor) => {
            const getterName = "_".concat(accessor, "Getter");
            const setterName = "_".concat(accessor, "Setter");
