...
const ValidationMessage = _ui.default.inherit({
    ...
    _getTextMarkup() {
        var _a;
        const validationErrors = null !== (_a = this.option("validationErrors")) && void 0 !== _a ? _a : [];
        let validationErrorMessage = "";
        validationErrors.forEach(err => {
            var _a;
            const separator = validationErrorMessage ? "<br />" : "";
            validationErrorMessage += separator + (0, _string.encodeHtml)(null !== (_a = null === err || void 0 === err ? void 0 : err.message) && void 0 !== _a ? _a : "")
        });
