...
const RANGE_SLIDER_START_HANDLE_CLASS = "".concat("dx-rangeslider", "-start-handle");
const RANGE_SLIDER_END_HANDLE_CLASS = "".concat("dx-rangeslider", "-end-handle");
const RangeSlider = _slider.default.inherit({
    ...
    _renderValue() {
        ...
        const startOffset = "".concat(parseFloat((100 * ratio1).toPrecision(12)), "%");
        const endOffset = "".concat(parseFloat((100 * (1 - ratio2)).toPrecision(12)), "%");
