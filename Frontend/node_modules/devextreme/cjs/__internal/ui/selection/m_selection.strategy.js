...
let SelectionStrategy = function() {
    ...
    _proto._getFullSelectAllState = function() {
        ...
        let selectedItems = this.options.ignoreDisabledItems ? this.options.selectedItems : this.options.selectedItems.filter(item => !(null === item || void 0 === item ? void 0 : item.disabled));
        if (dataFilter) {
