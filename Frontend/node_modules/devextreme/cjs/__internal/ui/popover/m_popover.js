...
const attachEvent = function(that, name) {
    ...
    const action = that._createAction(function() {
        const delay = getEventDelay(that, "".concat(name, "Event"));
    ...
    const EVENT_HANDLER_NAME = "_".concat(name, "EventHandler");
    if (isSelector) {
...
const detachEvent = function(that, target, name, event) {
    let eventName = event || getEventName(that, "".concat(name, "Event"));
    if (!eventName) {
        return
    }
...
const Popover = _ui.default.inherit({
    ...
    _init() {
        ...
        const isInteractive = null === (_a = this.option("toolbarItems")) || void 0 === _a ? void 0 : _a.length;
