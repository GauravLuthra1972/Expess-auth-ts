...
let DateRangeBox = function(_Editor) {
    ...
    _proto._getDefaultOptions = function() {
        ...
        return (0, _extend.extend)(_Editor.prototype._getDefaultOptions.call(this), {
            ...
            stylingMode: null !== (_a = (0, _config.default)().editorStylingMode) && void 0 !== _a ? _a : "outlined",
    ...
    _proto._defaultOptionsRules = function() {
        ...
        return _Editor.prototype._defaultOptionsRules.call(this).concat([{
            ...
            options: {
                labelMode: "floating",
                stylingMode: null !== (_a = (0, _config.default)().editorStylingMode) && void 0 !== _a ? _a : "filled"
            }
        }, {
            device() {
                const themeName = (0, _themes.current)();
    ...
    _proto._initTemplates = function() {
        ...
        _Editor.prototype._initTemplates.call(this)
    };
    ...
    _proto._renderSeparator = function() {
        ...
        null === $icon || void 0 === $icon ? void 0 : $icon.appendTo(this._$separator)
    };
    ...
    _proto._getStartDateBoxConfig = function() {
        var _a;
        const options = this.option();
        return _extends(_extends({}, this._getDateBoxConfig()), {
            ...
            deferRendering: options.deferRendering,
            disabledDates: null === (_a = options.dropDownOptions) || void 0 === _a ? void 0 : _a.disabledDates,
    ...
    _proto._focusTarget = function() {
        return (0, _renderer.default)(this.element()).find(".".concat("dx-texteditor-input"))
    };
    ...
    _proto._clean = function() {
        ...
        null === (_a = this._$startDateBox) || void 0 === _a ? void 0 : _a.remove();
        null === (_b = this._$endDateBox) || void 0 === _b ? void 0 : _b.remove();
        null === (_c = this._$separator) || void 0 === _c ? void 0 : _c.remove();
    ...
    _proto._optionChanged = function(args) {
        ...
        switch (name) {
            ...
            case "_internalValidationErrors": {
                ...
                this.option("isValid", !(null === validationErrors || void 0 === validationErrors ? void 0 : validationErrors.length));
                break
            }
            case "isValid": {
                this.getStartDateBox().option(name, value);
            ...
            case "validationErrors": {
                ...
                _Editor.prototype._optionChanged.call(this, _extends(_extends({}, args), {
                    value: newValue
                }));
                break
            }
