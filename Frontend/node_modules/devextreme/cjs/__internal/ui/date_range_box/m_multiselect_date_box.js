...
let MultiselectDateBox = function(_TypedDateBox) {
    _inheritsLoose(MultiselectDateBox, _TypedDateBox);

    function MultiselectDateBox() {
        return _TypedDateBox.apply(this, arguments) || this
    }
    ...
    _proto._initMarkup = function() {
        _TypedDateBox.prototype._initMarkup.call(this);
    ...
    _proto._openHandler = function(e) {
        ...
        _TypedDateBox.prototype._openHandler.call(this, e)
    };
    ...
    _proto._renderPopup = function() {
        _TypedDateBox.prototype._renderPopup.call(this);
        if (this._isStartDateBox()) {
    ...
    _proto._popupShownHandler = function() {
        var _a;
        _TypedDateBox.prototype._popupShownHandler.call(this);
        null === (_a = this._getDateRangeBox()._validationMessage) || void 0 === _a ? void 0 : _a.option("positionSide", this._getValidationMessagePositionSide())
    };
    _proto._popupHiddenHandler = function() {
        var _a;
        _TypedDateBox.prototype._popupHiddenHandler.call(this);
        null === (_a = this._getDateRangeBox()._validationMessage) || void 0 === _a ? void 0 : _a.option("positionSide", this._getValidationMessagePositionSide())
    };
    _proto._focusInHandler = function(e) {
        _TypedDateBox.prototype._focusInHandler.call(this, e);
        this._processValueChange(e)
    };
    ...
    _proto._invalidate = function() {
        _TypedDateBox.prototype._invalidate.call(this);
    ...
    _proto._isTargetOutOfComponent = function(target) {
        ...
        return _TypedDateBox.prototype._isTargetOutOfComponent.call(this, target) && isTargetOutOfDateRangeBox
    };
    _proto._updateLabelWidth = function() {
        ...
        _TypedDateBox.prototype._updateLabelWidth.call(this)
    };
        ...
        switch (args.name) {
            case "isValid": {
                ...
                if (this._skipIsValidOptionChange || isValid === args.value) {
                    _TypedDateBox.prototype._optionChanged.call(this, args);
                    return
                }
