...
const Drawer = _ui.default.inherit({
    ...
    _renderPanelContentWrapper() {
        ...
        if ("push" === openedStateMode && ["top", "bottom"].includes(position)) {
            this._$panelContentWrapper.addClass("".concat("dx-drawer-panel-content", "-push-top-or-bottom"))
        }
    ...
    _refreshOpenedStateModeClass(prevOpenedStateMode) {
        if (prevOpenedStateMode) {
            this.$element().removeClass("".concat("dx-drawer", "-").concat(prevOpenedStateMode))
        }
        this.$element().addClass("".concat("dx-drawer", "-").concat(this.option("openedStateMode")))
    },
    _refreshPositionClass(prevPosition) {
        if (prevPosition) {
            this.$element().removeClass("".concat("dx-drawer", "-").concat(prevPosition))
        }
        this.$element().addClass("".concat("dx-drawer", "-").concat(this.calcTargetPosition()))
    },
    ...
    _refreshRevealModeClass(prevRevealMode) {
        if (prevRevealMode) {
            this.$element().removeClass("".concat("dx-drawer", "-").concat(prevRevealMode))
        }
        this.$element().addClass("".concat("dx-drawer", "-").concat(this.option("revealMode")))
    },
    _renderViewContent() {
