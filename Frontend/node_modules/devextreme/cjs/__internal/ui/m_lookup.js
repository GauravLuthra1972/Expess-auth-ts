...
const Lookup = _ui.default.inherit({
    ...
    _inputWrapper() {
        return this.$element().find(".".concat("dx-lookup-field-wrapper"))
    },
    _dataSourceOptions() {
        return (0, _extend.extend)(this.callBase(), {
            paginate: true
    ...
    _getPopupOffset() {
        ...
        const selectedListItem = (0, _renderer.default)(this._list.element()).find(".".concat("dx-list-item-selected"));
    ...
    _listItemGroupedElements() {
        ...
        const items = [];
        groups.each((_, group) => {
            items.push((0, _renderer.default)(group).find(".".concat("dx-list-group-header"))[0]);
            const groupedItems = (0, _renderer.default)(group).find(".".concat("dx-list-item"));
    ...
    _calculateListHeight(grouped) {
        ...
        const selectedListItem = (0, _renderer.default)(".".concat("dx-list-item-selected"));
    ...
    _filterDataSource() {
        ...
        if (this._list && !this._list._dataSource && this._isMinSearchLengthExceeded()) {
            null === (_a = this._list) || void 0 === _a ? void 0 : _a._scrollView.startLoading()
        }
    ...
    _dataSourceFiltered() {
        var _a;
        this.callBase(...arguments);
        null === (_a = this._list) || void 0 === _a ? void 0 : _a._scrollView.finishLoading()
    },
    ...
    _renderPlaceholder() {
        if (0 === this.$element().find(".".concat("dx-texteditor-input")).length) {
            return
        }
        this.callBase()
    },
