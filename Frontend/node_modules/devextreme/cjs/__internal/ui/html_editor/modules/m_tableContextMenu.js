...
if (_devextremeQuill.default) {
    TableContextMenuModule = function(_BaseModule) {
        ...
        function TableContextMenuModule(quill, options) {
            ...
            _this._formatHandlers = (0, _m_toolbar_helper.getFormatHandlers)(_assertThisInitialized(_this));
            _this._tableFormats = (0, _m_table_helper.getTableFormats)(quill);
            if (_this.enabled) {
        ...
        _proto._enableContextMenu = function(items) {
            var _a;
            null === (_a = this._contextMenu) || void 0 === _a ? void 0 : _a.dispose();
        ...
        _proto._prepareMenuItemConfig = function(name) {
            var _a, _b;
            const iconName = null !== (_a = _m_toolbar_helper.ICON_MAP[name]) && void 0 !== _a ? _a : name;
            const buttonText = (0, _inflector.titleize)(name);
            return {
                text: localize(buttonText),
                icon: iconName.toLowerCase(),
                onClick: null !== (_b = this._formatHandlers[name]) && void 0 !== _b ? _b : (0, _m_toolbar_helper.getDefaultClickHandler)(this, name)
            }
        };
        ...
        _proto._getMenuConfig = function(items) {
            ...
            const customItems = this._prepareMenuItems((null === items || void 0 === items ? void 0 : items.length) ? items : defaultItems);
            return {
