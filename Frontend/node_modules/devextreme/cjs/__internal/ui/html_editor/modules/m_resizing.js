...
let ResizingModule = function(_BaseModule) {
    ...
    _proto._detachEvents = function() {
        _events_engine.default.off(this.quill.root, ".".concat(MODULE_NAMESPACE));
    ...
    _proto._prepareFramePositionChangedHandler = function() {
        return () => {
            if (this._$target) {
                this.updateFramePosition()
            }
    ...
    _proto._deleteImage = function() {
        ...
        if (this._isAllowedTarget(this._$target)) {
            null === (_a = _devextremeQuill.default.find(this._$target)) || void 0 === _a ? void 0 : _a.deleteAt(0)
        }
    };
