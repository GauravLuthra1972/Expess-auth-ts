...
let TableResizingModule = function(_BaseModule) {
    ...
    _proto._getFrameForTable = function($table) {
        var _a;
        return null === (_a = this._framesForTables) || void 0 === _a ? void 0 : _a.get($table.get(0))
    };
    ...
    _proto._fixTablesWidths = function($tables) {
        (0, _iterator.each)($tables, (index, table) => {
            ...
            if (0 === (0, _m_table_helper.getAutoSizedElements)($table).length) {
                ...
                const tableWidth = null !== (_a = this._tableLastWidth(frame)) && void 0 !== _a ? _a : (0, _size.getOuterWidth)($table);
                if (frame) {
    ...
    _proto._createResizeFrames = function($tables) {
        ...
        $tables.each((index, table) => {
            var _a;
            const $table = (0, _renderer.default)(table);
            const $lastTable = null === (_a = this._tableResizeFrames[index]) || void 0 === _a ? void 0 : _a.$table;
    ...
    _proto._removeResizeFrames = function(clearArray) {
        ...
        (0, _iterator.each)(this._tableResizeFrames, (index, resizeFrame) => {
            ...
            if (resizeFrame.$frame) {
                ...
                this._detachSeparatorEvents(null === (_a = resizeFrame.$frame) || void 0 === _a ? void 0 : _a.find(resizerElementsSelector));
                resizeFrame.$frame.remove()
            }
        });
        null === (_a = this._framesForTables) || void 0 === _a ? void 0 : _a.clear();
        if (clearArray) {
    ...
    _proto._createTableResizeFrame = function(table) {
    ...
    _proto._horizontalDragHandler = function(_ref2) {
        ...
        this._$highlightedElement.css(directionInfo.positionCoordinate, "".concat(this._startLineSeparatorPosition + eventOffset + realWidthDiff, "px"))
    };
    _proto._verticalDragHandler = function(_ref3) {
        ...
        this._$highlightedElement.css(directionInfo.positionCoordinate, "".concat(this._startLineSeparatorPosition + eventOffset + rowHeightDiff, "px"))
    };
    ...
    _proto._dragEndHandler = function(options) {
        var _a;
        null === (_a = this._$highlightedElement) || void 0 === _a ? void 0 : _a.remove();
