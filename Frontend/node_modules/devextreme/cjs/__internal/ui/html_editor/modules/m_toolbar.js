...
if (_devextremeQuill.default) {
    ...
    ToolbarModule = function(_BaseModule) {
        ...
        function ToolbarModule(quill, options) {
            ...
            _this._toolbarWidgets = new _m_widget_collector.default;
        ...
        _proto.isMultilineMode = function() {
            var _a;
            return null !== (_a = this.options.multiline) && void 0 !== _a ? _a : true
        };
        ...
        _proto.updateFormatWidgets = function(isResetRequired) {
            ...
            for (const formatName in formats) {
                ...
                const formatWidget = null !== (_a = this._toolbarWidgets.getByName(widgetName)) && void 0 !== _a ? _a : this._toolbarWidgets.getByName(formatName);
                if (!formatWidget) {
                    continue
                }
