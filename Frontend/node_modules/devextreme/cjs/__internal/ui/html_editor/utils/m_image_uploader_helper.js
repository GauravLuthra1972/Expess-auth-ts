...
let ImageUploader = function() {
    ...
    _proto.getUpdateDialogFormData = function(formData) {
        const {
            imageSrc: imageSrc,
            src: src
        } = formData, props = __rest(formData, ["imageSrc", "src"]);
        return _extends({
    ...
    _proto.isImageUpdating = function() {
        var _a;
        return Object.prototype.hasOwnProperty.call(null !== (_a = this.module.quill.getFormat()) && void 0 !== _a ? _a : {}, "imageSrc")
    };
...
let BaseStrategy = function() {
    ...
    _proto5.pasteImage = function(formData, event) {};
        ...
        return this.editorInstance._createComponent($container, _text_box.default, (0, _extend.extend)(true, data.editorOptions, {
            ...
            onValueChanged: e => {
                this.keepAspectRatio(data, {
                    dependentEditor: this["".concat(dependentEditorDataField, "Editor")],
                    e: e
                })
            }
        }))
...
let UpdateUrlStrategy = function(_AddUrlStrategy) {
    ...
    _proto7.modifyFormData = function() {
        ...
        if (imgElement) {
            this.formData.width = null !== (_a = this.formData.width) && void 0 !== _a ? _a : (0, _size.getWidth)((0, _renderer.default)(imgElement));
            this.formData.height = null !== (_b = this.formData.height) && void 0 !== _b ? _b : (0, _size.getHeight)((0, _renderer.default)(imgElement))
        }
    };
    ...
    _proto7.embedFormatIndex = function() {
        var _a;
        const selection = null !== (_a = this.selection) && void 0 !== _a ? _a : this.quill.getSelection();
        if (selection) {
            if (selection.length) {
...
function correctSlashesInUrl(url) {
    return "/" !== url[url.length - 1] ? "".concat(url, "/") : url
}
