    ...
    return {
        clear: _ref => {
            ...
            if (range) {
                ...
                null === (_a = getToolbarModule(module)) || void 0 === _a ? void 0 : _a.updateFormatWidgets()
            }
        },
...
function prepareShowFormProperties(module, type) {
    return $element => {
        var _a;
        if (!(null === $element || void 0 === $element ? void 0 : $element.length)) {
            $element = (0, _renderer.default)(getTargetTableNode(module, type))
        }
        const [tableBlot, rowBlot] = null !== (_a = module.quill.getModule("table").getTable()) && void 0 !== _a ? _a : [];
...
function prepareLinkHandler(module) {
    return () => {
        ...
        const isCursorAtLink = void 0 !== formats.link && 0 === (null === selection || void 0 === selection ? void 0 : selection.length);
...
function prepareShortcutHandler(module, name, shortcutValue) {
    return _ref7 => {
        ...
        null === (_a = getToolbarModule(module)) || void 0 === _a ? void 0 : _a.updateFormatWidgets(true)
    }
}
...
function getDefaultClickHandler(module, name) {
    return _ref8 => {
        ...
        null === (_a = getToolbarModule(module)) || void 0 === _a ? void 0 : _a._updateFormatWidget(name, newValue, formats)
    }
}
...
function getTablePropertiesFormConfig(module, _ref9) {
    ...
    return {
        ...
        applyHandler: formInstance => {
            ...
            module.editorInstance.format("tableBorderWidth", "".concat(formData.borderWidth, "px"));
...
function getCellPropertiesFormConfig(module, _ref10) {
    ...
    return {
        ...
        applyHandler: formInstance => {
            ...
            module.editorInstance.format("cellBorderWidth", "".concat(formData.borderWidth, "px"));
            ...
            module.editorInstance.format("cellPaddingLeft", "".concat(formData.horizontalPadding, "px"));
            module.editorInstance.format("cellPaddingRight", "".concat(formData.horizontalPadding, "px"));
            module.editorInstance.format("cellPaddingTop", "".concat(formData.verticalPadding, "px"));
            module.editorInstance.format("cellPaddingBottom", "".concat(formData.verticalPadding, "px"))
        }
    }
}
...
function applyTableDimensionChanges(module, _ref11) {
    ...
    if ((0, _type.isDefined)(newWidth)) {
        ...
        if (autoWidthColumns.length > 0) {
            module.editorInstance.format("tableWidth", "".concat(newWidth, "px"))
        } else {
    ...
    if ((null === autoHeightRows || void 0 === autoHeightRows ? void 0 : autoHeightRows.length) > 0) {
        tableBlot.format("tableHeight", "".concat(newHeight, "px"))
    } else {
...
function applyCellDimensionChanges(module, _ref12) {
    ...
    rowBlot.children.forEach(rowCell => {
        rowCell.format("cellHeight", "".concat(newHeight, "px"))
    });
    const autoHeightRows = (0, _m_table_helper.getAutoSizedElements)($table, "vertical");
