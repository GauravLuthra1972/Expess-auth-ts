...
const DateBoxMask = _m_date_box.default.inherit({
    ...
    _isSingleDigitKey(e) {
        var _a;
        const data = null === (_a = e.originalEvent) || void 0 === _a ? void 0 : _a.data;
    ...
    _partLimitsReached(max) {
        ...
        const isValueOverflowed = parseInt("".concat(this._searchValue, "0")) > max;
    ...
    _detachMaskEvents() {
        _events_engine.default.off(this._input(), ".".concat("dateBoxMask"))
    },
    _attachMaskEvents() {
