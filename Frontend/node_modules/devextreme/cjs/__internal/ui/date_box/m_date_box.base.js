...
const DateBox = _m_drop_down_editor.default.inherit({
    ...
    _refreshFormatClass() {
        ...
        (0, _iterator.each)(TYPE, (_, item) => {
            $element.removeClass("".concat("dx-datebox", "-").concat(item))
        });
        $element.addClass("".concat("dx-datebox", "-").concat(this.option("type")))
    },
    _refreshPickerTypeClass() {
        ...
        $element.addClass("".concat("dx-datebox", "-").concat(this._pickerType))
    },
    ...
    _getClearButtonWidth() {
        ...
        if (this._isClearButtonVisible() && "" === this._input().val()) {
            const clearButtonElement = this.$element().find(".".concat(DX_CLEAR_BUTTON_CLASS)).get(0);
    ...
    _renderPopupWrapper() {
        ...
        (0, _iterator.each)(classPostfixes, (_, item) => {
            $element.removeClass("".concat("dx-datebox-wrapper", "-").concat(item))
        });
        this._popup.$wrapper().addClass("".concat("dx-datebox-wrapper", "-").concat(this.option("type"))).addClass("".concat("dx-datebox-wrapper", "-").concat(this._pickerType)).addClass("dx-dropdowneditor-overlay")
    },
    _renderPopupContent() {
        this.callBase();
