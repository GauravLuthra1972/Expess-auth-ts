...
const DateView = _editor.default.inherit({
    ...
    _toggleFormatClasses(currentFormat, previousFormat) {
        this.$element().addClass("".concat("dx-dateview", "-").concat(currentFormat));
        previousFormat && this.$element().removeClass("".concat("dx-dateview", "-").concat(previousFormat))
    },
    _toggleCompactClass() {
    ...
    _renderRollers() {
        ...
        (0, _iterator.each)(that._rollerConfigs, name => {
            const $roller = (0, _renderer.default)("<div>").appendTo(that._$rollersContainer).addClass("".concat("dx-dateviewroller", "-").concat(that._rollerConfigs[name].type));
