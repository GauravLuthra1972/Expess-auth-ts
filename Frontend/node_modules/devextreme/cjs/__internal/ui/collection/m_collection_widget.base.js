...
const CollectionWidget = _ui.default.inherit({
    ...
    _optionChanged(args) {
        if ("items" === args.name) {
            ...
            if (matches && matches.length) {
                ...
                const itemPath = args.fullName.replace(".".concat(property), "");
    ...
    _renderItem(index, itemData, $container, $itemToReplace) {
        var _a;
        const itemIndex = null !== (_a = null === index || void 0 === index ? void 0 : index.item) && void 0 !== _a ? _a : index;
    ...
    _getItemContent($itemFrame) {
        const $itemContent = $itemFrame.find(".".concat("dx-item-content-placeholder"));
    ...
    _itemOptions() {
        ...
        return {
            ...
            owner: that,
            fieldGetter(field) {
                const expr = that.option("".concat(field, "Expr"));
    ...
    getFocusedItemId() {
        if (!this._focusedItemId) {
            this._focusedItemId = "dx-".concat(new _guid.default)
        }
