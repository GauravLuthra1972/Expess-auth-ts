...
const DX_MENU_VERTICAL_CLASS = "".concat("dx-menu", "-vertical");
const DX_MENU_HORIZONTAL_CLASS = "".concat("dx-menu", "-horizontal");
const DX_MENU_ITEM_CLASS = "".concat("dx-menu", "-item");
const DX_MENU_ITEMS_CONTAINER_CLASS = "".concat("dx-menu", "-items-container");
const DX_MENU_ITEM_EXPANDED_CLASS = "".concat(DX_MENU_ITEM_CLASS, "-expanded");
const DX_CONTEXT_MENU_CLASS = "dx-context-menu";
const DX_CONTEXT_MENU_CONTAINER_BORDER_CLASS = "".concat("dx-context-menu", "-container-border");
...
const DX_ADAPTIVE_MODE_CLASS = "".concat("dx-menu", "-adaptive-mode");
const DX_ADAPTIVE_HAMBURGER_BUTTON_CLASS = "".concat("dx-menu", "-hamburger-button");
const DX_ADAPTIVE_MODE_OVERLAY_WRAPPER_CLASS = "".concat(DX_ADAPTIVE_MODE_CLASS, "-overlay-wrapper");
const FOCUS_UP = "up";
...
let Menu = function(_MenuBase) {
    ...
    _proto._getAdaptiveOverlayOptions = function() {
        ...
        return {
            ...
            height: "auto",
            hideOnOutsideClick: e => !(0, _renderer.default)(e.target).closest(".".concat(DX_ADAPTIVE_HAMBURGER_BUTTON_CLASS)).length,
            position: {
                collision: "flipfit",
    ...
    _proto._attachSubmenuHandlers = function($menuAnchorItem, submenu) {
        const $submenuOverlayContent = submenu.getOverlayContent();
        const submenus = $submenuOverlayContent.find(".".concat("dx-submenu"));
        const submenuMouseLeaveName = (0, _index.addNamespace)(_hover.end, "".concat(this.NAME, "_submenu"));
        submenu.option({
    ...
    _proto.unselectItem = function(itemElement) {
        this._hideSubmenu(this._visibleSubmenu);
        _MenuBase.prototype.unselectItem.call(this, itemElement)
    };
    return Menu
}(_m_menu_base.default);
