...
let FileUploader = function(_Editor) {
    ...
    _proto._focusTarget = function() {
        return this.$element().find(".".concat("dx-fileuploader-button"))
    };
    ...
    _proto._renderFiles = function() {
        ...
        null === (_a = this._validationMessage) || void 0 === _a ? void 0 : _a.repaint()
    };
    ...
    _proto._updateFileNameMaxWidth = function() {
        ...
        const filesContainerWidth = (0, _size.getWidth)(this._$filesContainer.find(".".concat("dx-fileuploader-file-container")).first()) || (0, _size.getWidth)(this._$filesContainer);
        const $buttonContainer = this._$filesContainer.find(".".concat("dx-fileuploader-button-container")).eq(0);
        const buttonsWidth = (0, _size.getWidth)($buttonContainer) * (cancelButtonsCount + uploadButtonsCount);
        const $fileSize = this._$filesContainer.find(".".concat("dx-fileuploader-file-size")).eq(0);
        const prevFileSize = $fileSize.text();
        $fileSize.text("1000 Mb");
        const fileSizeWidth = (0, _size.getWidth)($fileSize);
        $fileSize.text(prevFileSize);
        this._$filesContainer.find(".".concat("dx-fileuploader-file-name")).css("maxWidth", filesContainerWidth - buttonsWidth - fileSizeWidth)
    };
    ...
    _proto._getCancelButton = function(file) {
        ...
        file.cancelButton = this._createComponent((0, _renderer.default)("<div>").addClass("".concat("dx-fileuploader-button", " ").concat("dx-fileuploader-cancel-button")), _button.default, {
    ...
    _proto._getUploadButton = function(file) {
        ...
        file.uploadButton = this._createComponent((0, _renderer.default)("<div>").addClass("".concat("dx-fileuploader-button", " ").concat("dx-fileuploader-upload-button")), _button.default, {
    ...
    _proto._removeFile = function(file) {
        var _a;
        null === (_a = file.$file) || void 0 === _a ? void 0 : _a.parent().remove();
    ...
    _proto._getFileSize = function(size) {
        ...
        return "".concat(Math.round(size), " ").concat(labels[i])
    };
    ...
    _proto._isFileTypeAllowed = function(file, allowedTypes) {
        for (let i = 0, n = allowedTypes.length; i < n; i++) {
            ...
            if ("." === allowedType[0]) {
                ...
                if (file.name.match(new RegExp("".concat(allowedType, "$"), "i"))) {
                    return true
                }
            } else {
    ...
    _proto._createProgressBar = function(fileSize) {
        return this._createComponent((0, _renderer.default)("<div>"), _progress_bar.default, {
            ...
            min: 0,
            max: fileSize,
            statusFormat: ratio => "".concat(this._getProgressValue(ratio), "%"),
            showStatus: false,
    ...
    _proto._updateReadOnlyState = function() {
        ...
        this._files.forEach(file => {
            var _a;
            return null === (_a = file.cancelButton) || void 0 === _a ? void 0 : _a.option("disabled", readOnly)
        });
        this._updateInputLabelText();
        this._attachDragEventHandlers(this._$inputWrapper)
    };
    _proto._updateHoverState = function() {
        ...
        null === (_a = this._selectButton) || void 0 === _a ? void 0 : _a.option("hoverStateEnabled", value);
        null === (_b = this._uploadButton) || void 0 === _b ? void 0 : _b.option("hoverStateEnabled", value);
        this._files.forEach(file => {
            var _a, _b;
            null === (_a = file.uploadButton) || void 0 === _a ? void 0 : _a.option("hoverStateEnabled", value);
            null === (_b = file.cancelButton) || void 0 === _b ? void 0 : _b.option("hoverStateEnabled", value)
        })
    };
    _proto._optionChanged = function(args) {
        ...
        switch (name) {
            ...
            case "_buttonStylingMode":
                this._files.forEach(file => {
                    var _a, _b;
                    null === (_a = file.uploadButton) || void 0 === _a ? void 0 : _a.option("stylingMode", value);
                    null === (_b = file.cancelButton) || void 0 === _b ? void 0 : _b.option("stylingMode", value)
                });
                break;
            case "dialogTrigger":
...
let FileUploadStrategyBase = function() {
    ...
    _proto3._prepareFileBeforeUpload = function(file) {
        var _a;
        if (file.$file) {
            null === (_a = file.progressBar) || void 0 === _a ? void 0 : _a.dispose();
