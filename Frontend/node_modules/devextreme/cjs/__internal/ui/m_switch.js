...
const SWITCH_WRAPPER_CLASS = "".concat("dx-switch", "-wrapper");
const SWITCH_CONTAINER_CLASS = "".concat("dx-switch", "-container");
const SWITCH_INNER_CLASS = "".concat("dx-switch", "-inner");
const SWITCH_HANDLE_CLASS = "".concat("dx-switch", "-handle");
const SWITCH_ON_VALUE_CLASS = "".concat("dx-switch", "-on-value");
const SWITCH_ON_CLASS = "".concat("dx-switch", "-on");
const SWITCH_OFF_CLASS = "".concat("dx-switch", "-off");
