...
const Resizable = _dom_component.default.inherit({
    ...
    _renderHandle(handleName) {
        const $handle = (0, _renderer.default)("<div>").addClass("dx-resizable-handle").addClass("".concat("dx-resizable-handle", "-").concat(handleName)).appendTo(this.$element());
    ...
    _renderDragOffsets(e) {
        ...
        const $handle = (0, _renderer.default)(e.target).closest(".".concat("dx-resizable-handle"));
    ...
    _getMovingSides(e) {
        ...
        const hasCornerTopLeftClass = $target.hasClass("".concat("dx-resizable-handle-corner", "-top-left"));
        const hasCornerTopRightClass = $target.hasClass("".concat("dx-resizable-handle-corner", "-top-right"));
        const hasCornerBottomLeftClass = $target.hasClass("".concat("dx-resizable-handle-corner", "-bottom-left"));
        const hasCornerBottomRightClass = $target.hasClass("".concat("dx-resizable-handle-corner", "-bottom-right"));
        return {
    ...
    _clean() {
        this.$element().find(".".concat("dx-resizable-handle")).remove()
    },
    _useTemplates: () => false
});
