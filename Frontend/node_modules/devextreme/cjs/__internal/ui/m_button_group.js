...
const BUTTON_GROUP_WRAPPER_CLASS = "".concat("dx-buttongroup", "-wrapper");
const BUTTON_GROUP_ITEM_CLASS = "".concat("dx-buttongroup", "-item");
const BUTTON_GROUP_FIRST_ITEM_CLASS = "".concat("dx-buttongroup", "-first-item");
const BUTTON_GROUP_LAST_ITEM_CLASS = "".concat("dx-buttongroup", "-last-item");
