...
let SpeedDialMainItem = function(_SpeedDialItem) {
    ...
    _proto._getCurrentOptions = function(actions) {
        const visibleActions = null === speedDialMainItem || void 0 === speedDialMainItem ? void 0 : speedDialMainItem._getVisibleActions(actions);
    ...
    _proto._clickHandler = function() {
        ...
        if (null === (_a = (0, _config.default)().floatingActionButtonConfig) || void 0 === _a ? void 0 : _a.shading) {
