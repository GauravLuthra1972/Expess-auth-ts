...
const DX_MENU_ITEM_WRAPPER_CLASS = "".concat(DX_MENU_ITEM_CLASS, "-wrapper");
...
let ContextMenu = function(_MenuBase) {
    ...
    _proto.getShowEvent = function(showEventOption) {
        ...
        if ((0, _type.isObject)(showEventOption)) {
            if (null !== showEventOption.name) {
                return null !== (_a = showEventOption.name) && void 0 !== _a ? _a : "dxcontextmenu"
            }
        } else {
    ...
    _proto._getActiveItem = function(last) {
    ...
    _proto._show = function(event) {
        ...
        if (position) {
            ...
            if ((null === (_a = null === event || void 0 === event ? void 0 : event.originalEvent) || void 0 === _a ? void 0 : _a.type) === _hold.default.name) {
