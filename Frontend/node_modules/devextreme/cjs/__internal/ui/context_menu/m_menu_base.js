...
const DX_MENU_NO_ICONS_CLASS = "".concat("dx-menu", "-no-icons");
const DX_MENU_BASE_CLASS = "dx-menu-base";
const ITEM_CLASS = "".concat("dx-menu", "-item");
const DX_ITEM_CONTENT_CLASS = "".concat(ITEM_CLASS, "-content");
const DX_MENU_SELECTED_ITEM_CLASS = "".concat(ITEM_CLASS, "-selected");
const DX_MENU_ITEM_WRAPPER_CLASS = "".concat(ITEM_CLASS, "-wrapper");
const DX_MENU_ITEMS_CONTAINER_CLASS = "".concat("dx-menu", "-items-container");
const DX_MENU_ITEM_EXPANDED_CLASS = "".concat(ITEM_CLASS, "-expanded");
const DX_MENU_SEPARATOR_CLASS = "".concat("dx-menu", "-separator");
const DX_MENU_ITEM_LAST_GROUP_ITEM = "".concat("dx-menu", "-last-group-item");
const DX_ITEM_HAS_TEXT = "".concat(ITEM_CLASS, "-has-text");
const DX_ITEM_HAS_ICON = "".concat(ITEM_CLASS, "-has-icon");
const DX_ITEM_HAS_SUBMENU = "".concat(ITEM_CLASS, "-has-submenu");
const DX_MENU_ITEM_POPOUT_CLASS = "".concat(ITEM_CLASS, "-popout");
const DX_MENU_ITEM_POPOUT_CONTAINER_CLASS = "".concat(DX_MENU_ITEM_POPOUT_CLASS, "-container");
const DX_MENU_ITEM_CAPTION_CLASS = "".concat(ITEM_CLASS, "-text");
...
let MenuBase = function(_HierarchicalCollecti) {
    ...
    _proto._setAriaSelectionAttribute = function($itemElement, isSelected) {};
    ...
    _proto._getLinkContainer = function(iconContainer, textContainer, itemData) {
        const {
            linkAttr: linkAttr,
            url: url
        } = itemData;
    ...
    _proto._hoverEndHandler = function(event) {
        clearTimeout(this._showSubmenusTimeout)
    };
    ...
    _proto._renderItem = function(index, node, $nodeContainer, $nodeElement) {
        ...
        const $node = null !== $nodeElement && void 0 !== $nodeElement ? $nodeElement : this._createDOMElement($nodeContainer);
