...
function renderLabel(_ref) {
    ...
    const $label = (0, _renderer.default)("<label>").addClass("".concat(_constants.FIELD_ITEM_LABEL_CLASS, " ").concat("dx-field-item-label-location-").concat(location)).attr("for", id).attr("id", labelID).css("textAlign", alignment);
