...
const SelectBox = _ui.default.inherit({
    ...
    _popupWrapperClass() {
        return "".concat(this.callBase(), " ").concat("dx-selectbox-popup-wrapper")
    },
    ...
    _focusSelectedElement() {
        ...
        const index = null !== (_a = null === items || void 0 === items ? void 0 : items.indexOf(selectedItem)) && void 0 !== _a ? _a : -1;
    ...
    _cancelSearchIfNeed(e) {
        ...
        if (shouldCancelSearch) {
            const isPopupVisible = null === (_a = this._popup) || void 0 === _a ? void 0 : _a._hideAnimationProcessing;
            this._clearSearchTimer();
            if (isPopupVisible) {
    ...
    _isOverlayNestedTarget: target => !!(0, _renderer.default)(target).closest(".".concat("dx-selectbox-popup-wrapper")).length,
    _clearTextValue() {
