...
const Slider = _m_track_bar.default.inherit({
    ...
    _renderHandleImpl(value, $element) {
        ...
        this.$element().toggleClass("".concat("dx-slider-tooltip-position-", "bottom"), tooltip.enabled && "bottom" === tooltip.position).toggleClass("".concat("dx-slider-tooltip-position-", "top"), tooltip.enabled && "top" === tooltip.position);
    ...
    _renderLabels() {
        this.$element().removeClass("".concat("dx-slider-label-position-", "bottom")).removeClass("".concat("dx-slider-label-position-", "top"));
    ...
    _updateHandlePosition(e) {
        ...
        (0, _size.setWidth)(this._$range, "".concat(100 * newRatio, "%"));
