...
let KeyboardNavigationController = function(_modules$ViewControll) {
    ...
    _proto._toggleInertAttr = function(value) {};
...
const rowsView = Base => function(_Base) {
    ...
    _proto2.renderFocusState = function(params) {
        _Base.prototype.renderFocusState.call(this, params);
        const {
            preventScroll: preventScroll,
...
const editing = Base => function(_Base2) {
    ...
    _proto3.closeEditCell = function() {
        ...
        const isFilterCell = !!$focusedElement.closest(".".concat(this.addWidgetPrefix(_const.FILTER_ROW_CLASS))).length;
        if (!isFilterCell) {
            keyboardNavigation._updateFocus()
        }
        return result
    };
    _proto3._getFocusedElement = function() {
        var _a, _b;
        const $element = (0, _renderer.default)(null === (_b = (_a = this.component).element) || void 0 === _b ? void 0 : _b.call(_a));
...
const adaptiveColumns = Base => function(_Base4) {
    ...
    _proto5._hideVisibleColumnInView = function(_ref3) {
        let {
            view: view,
            isCommandColumn: isCommandColumn,
            visibleIndex: visibleIndex
        } = _ref3;
        _Base4.prototype._hideVisibleColumnInView.call(this, {
            view: view,
            isCommandColumn: isCommandColumn,
            visibleIndex: visibleIndex
        });
