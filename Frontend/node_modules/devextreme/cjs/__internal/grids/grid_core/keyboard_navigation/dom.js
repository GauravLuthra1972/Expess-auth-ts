...
const getFocusableCellSelector = columnIndex => ["[".concat(_const.ATTRIBUTES.ariaColIndex, '="').concat(columnIndex + 1, '"]'), ":not([".concat(_const.ATTRIBUTES.dragCell, "])"), ":not([aria-hidden=true])"].join("");
