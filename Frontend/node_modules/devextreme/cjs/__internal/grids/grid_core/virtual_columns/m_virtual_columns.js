...
const baseView = Base => function(_Base) {
    ...
    _proto._needToSetCellWidths = function() {
        let result = _Base.prototype._needToSetCellWidths.call(this);
...
const rowsView = Base => function(_baseView) {
...
const columnHeadersView = Base => function(_baseView2) {
    ...
    _proto3._renderCore = function() {
        const deferred = _baseView2.prototype._renderCore.apply(this, arguments);
...
const columns = Base => function(_Base2) {
    ...
    _proto4.getFixedColumns = function(rowIndex, isBase) {
        const fixedColumns = _Base2.prototype.getFixedColumns.call(this, rowIndex);
    ...
    _proto4._compileVisibleColumns = function(rowIndex, isBase) {
        ...
        let visibleColumns = _Base2.prototype._compileVisibleColumns.call(this);
