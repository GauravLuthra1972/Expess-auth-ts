...
let RowsView = function(_ColumnsView) {
    ...
    _proto.renderFocusState = function(params) {};
    ...
    _proto.getFixedContentElement = function() {
        var _a;
    ...
    _proto.isElementInside = function($element) {
        const $rowsViewElement = $element.closest(".".concat(this.addWidgetPrefix("rowsview")));
