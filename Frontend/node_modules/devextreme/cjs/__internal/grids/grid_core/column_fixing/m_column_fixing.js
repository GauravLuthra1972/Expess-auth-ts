...
const baseFixedColumns = Base => function(_Base) {
    ...
    _proto.isIndicesArray = function(arr) {
    ...
    _proto._correctColumnIndicesForFixedColumns = function(fixedColumns, change) {
        ...
        const rowTypes = null === (_a = null === change || void 0 === change ? void 0 : change.items) || void 0 === _a ? void 0 : _a.map(_ref => {
            let {
                rowType: rowType
            } = _ref;
            return rowType
    ...
    _proto._partialUpdateFixedTable = function(fixedColumns, rows) {
    ...
    _proto._partialUpdateFixedRow = function($row, fixedColumns, row) {
        var _a;
        ...
        if (!isFixedTableRendering && this._isFixedColumns) {
            ...
            if (isGroupCell) {
                ...
                if (options.row.summaryCells && options.row.summaryCells.length) {
                    ...
                    const alignByFixedColumnCellCount = null !== (_b = null === (_a = this._getAlignByColumnCellCount) || void 0 === _a ? void 0 : _a.call(this, column.colspan, {
                        columns: columns,
                        row: options.row,
                        isFixed: true
                    })) && void 0 !== _b ? _b : 0;
...
const keyboardNavigation = Base => function(_Base5) {
    _inheritsLoose(KeyboardNavigationExtender, _Base5);

    function KeyboardNavigationExtender() {
        return _Base5.apply(this, arguments) || this
    }
    var _proto7 = KeyboardNavigationExtender.prototype;
    _proto7._toggleInertAttr = function(value) {
        var _a;
        const $fixedContent = null === (_a = this._rowsView) || void 0 === _a ? void 0 : _a.getFixedContentElement();
        if (value) {
    ...
    return KeyboardNavigationExtender
}(Base);
