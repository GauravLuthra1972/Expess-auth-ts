...
let ColumnsController = function(_modules$Controller) {
    ...
    _proto.updateSortingGrouping = function(dataSource, fromDataSource) {
        ...
        if (dataSource) {
            ...
            const changeTypes = null === (_a = this._columnChanges) || void 0 === _a ? void 0 : _a.changeTypes;
            const sortingChanged = !_m_utils.default.equalSortParameters(sortParameters, columnsSortParameters);
            const needToApplySortingFromDataSource = fromDataSource && !(null === changeTypes || void 0 === changeTypes ? void 0 : changeTypes.sorting);
            const needToApplyGroupingFromDataSource = fromDataSource && !(null === changeTypes || void 0 === changeTypes ? void 0 : changeTypes.grouping);
