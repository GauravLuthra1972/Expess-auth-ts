...
const data = Base => function(_Base4) {
    ...
    function FocusDataControllerExtender() {
        var _this;
        _this = _Base4.apply(this, arguments) || this;
        _this._needToUpdateFocusedRowByIndex = false;
        return _this
    }
    ...
    _proto5._handleDataPushed = function(changes) {
        _Base4.prototype._handleDataPushed.call(this, changes);
        const focusedRowKey = this.option("focusedRowKey");
