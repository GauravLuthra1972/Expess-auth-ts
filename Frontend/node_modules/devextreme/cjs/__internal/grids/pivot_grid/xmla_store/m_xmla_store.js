...
const XmlaStore = _class.default.inherit(function() {
    ...
    function preparePathValue(pathValue, dataField) {
        if (pathValue) {
            const shouldSkipWrappingPathValue = (0, _type.isString)(pathValue) && (pathValue.includes("&") || pathValue.startsWith("".concat(dataField, ".")));
            pathValue = shouldSkipWrappingPathValue ? pathValue : "[".concat(pathValue, "]");
