...
exports.agendaUtils = agendaUtils;
const dayUtils = {
    calculateStartViewDate: _day.calculateStartViewDate
};
exports.dayUtils = dayUtils;
const weekUtils = {
...
exports.weekUtils = weekUtils;
const workWeekUtils = {
    calculateStartViewDate: _work_week.calculateStartViewDate
};
exports.workWeekUtils = workWeekUtils;
const monthUtils = {
...
exports.monthUtils = monthUtils;
const timelineWeekUtils = {
    getDateForHeaderText: _timeline_week.getDateForHeaderText
};
exports.timelineWeekUtils = timelineWeekUtils;
const timelineMonthUtils = {
    calculateStartViewDate: _timeline_month.calculateStartViewDate
};
exports.timelineMonthUtils = timelineMonthUtils;
const viewsUtils = {
    getCurrentView: _views.getCurrentView
};
exports.viewsUtils = viewsUtils;
const renderUtils = {
