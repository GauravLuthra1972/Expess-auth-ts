...
let GroupPanelHorizontalRow = function(_BaseInfernoComponent) {
    ...
    _proto.render = function() {
        ...
        return (0, _inferno.createVNode)(1, "tr", "dx-scheduler-group-row ".concat(className), groupItems.map((_ref, index) => {
            ...
            return (0, _inferno.createComponentVNode)(2, _group_panel_horizontal_cell.GroupPanelHorizontalCell, {
                ...
                index: index,
                color: color,
                colSpan: null !== colSpan && void 0 !== colSpan ? colSpan : _group_panel_horizontal_cell.GroupPanelHorizontalCellDefaultProps.colSpan,
                isFirstGroupCell: !!isFirstGroupCell,
                isLastGroupCell: !!isLastGroupCell,
