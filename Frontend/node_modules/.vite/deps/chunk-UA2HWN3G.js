...
var number_default = {
  ...
  _extractCurrencySymbolInfo: function(currencyValueString) {
    ...
    var position2 = match[1] ? "before" : "after";
...
var resizeCallbacks = (function() {
  ...
  var formatSize = function() {
    ...
    return {
      width: window12.innerWidth,
      height: window12.innerHeight
    };
  };
...
function attachCssClasses(element, themeName) {
  ...
  !(function() {
    var pixelRatio = hasWindow() && window3.devicePixelRatio;
...
var clearSelection = () => {
  var selection = window4.getSelection();
  if (!selection) {
    return;
  }
...
var clipboardText = (event, text) => {
  var clipboard = event.originalEvent && event.originalEvent.clipboardData || window4.clipboardData;
  if (!text) {
...
var createTextElementHiddenCopy = (element, text, options) => {
  var elementStyles = window4.getComputedStyle(renderer_default(element).get(0));
...
var setAnimationFrameMethods = call_once_default((function() {
  var nativeRequest = window5.requestAnimationFrame || window5.webkitRequestAnimationFrame || window5.mozRequestAnimationFrame || window5.oRequestAnimationFrame || window5.msRequestAnimationFrame;
  var nativeCancel = window5.cancelAnimationFrame || window5.webkitCancelAnimationFrame || window5.mozCancelAnimationFrame || window5.oCancelAnimationFrame || window5.msCancelAnimationFrame;
...
var calculatePosition = function(what, options) {
  ...
  var of = renderer_default(options.of).length && options.of || window6;
  ...
  initMyLocation(v);
  var bounds = (function() {
    var win = renderer_default(window6);
...
function setupPosition($element, config) {
  ...
  var win = renderer_default(window7);
  var left = 0;
  var top = 0;
...
var OverlayPositionController = class {
  ...
  _getVisualContainer() {
    ...
    return renderer_default(window8);
  }
...
var Overlay = ui_widget_default.inherit({
  ...
  _documentDownHandler(e) {
    ...
    var isAttachedTarget = renderer_default(window9.document).is(e.target) || contains(window9.document, e.target);
  ...
  _toggleSafariScrolling() {
    ...
    if (isIosSafari) {
      if (shouldEnableScrolling) {
        ...
        window9.scrollTo(0, this._cachedBodyScrollTop);
        this._cachedBodyScrollTop = void 0;
      } else if (shouldPreventScrolling) {
        this._cachedBodyScrollTop = window9.pageYOffset;
  ...
  _renderWrapperDimensions() {
    ...
    var wrapperHeight = isVisualContainerWindow ? window9.innerHeight : getOuterHeight($visualContainer);
    this._$wrapper.css({
      width: wrapperWidth,
...
var nativeXMLHttpRequest = {
  getXhr: function() {
    return new window10.XMLHttpRequest();
  }
};
...
var isCrossDomain = function(url) {
  ...
  originAnchor.href = window11.location.href;
  try {
    urlAnchor.href = url;
...
var getRequestOptions = function(options, headers) {
  ...
  var url = options.url || window11.location.href;
...
var sendRequest = function(options) {
  ...
  if (callbackName) {
    window11[callbackName] = function(data2) {
...
var m_utils_default = {
  ...
  getPixelRatio: (window12) => window12.devicePixelRatio || 1,
...
//# sourceMappingURL=chunk-UA2HWN3G.js.map
