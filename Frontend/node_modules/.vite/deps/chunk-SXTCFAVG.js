...
var setAnimationFrameMethods = call_once_default((function() {
  const nativeRequest = window8.requestAnimationFrame || window8.webkitRequestAnimationFrame || window8.mozRequestAnimationFrame || window8.oRequestAnimationFrame || window8.msRequestAnimationFrame;
  const nativeCancel = window8.cancelAnimationFrame || window8.webkitCancelAnimationFrame || window8.mozCancelAnimationFrame || window8.oCancelAnimationFrame || window8.msCancelAnimationFrame;
...
var calculatePosition = function(what, options) {
  ...
  let of = renderer_default(options.of).length && options.of || window9;
...
var clearSelection = () => {
  const selection = window11.getSelection();
  if (!selection) {
    return;
  }
...
var window12 = m_window_default.getWindow();
...
var window13 = m_window_default.getWindow();
...
var Overlay = class _Overlay extends widget_default {
  ...
  _documentDownHandler(e) {
    ...
    const isAttachedTarget = renderer_default(window13.document).is(e.target) || m_dom_default.contains(window13.document, e.target);
...
//# sourceMappingURL=chunk-SXTCFAVG.js.map
