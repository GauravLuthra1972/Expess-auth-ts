...
var resizeCallbacks = (function() {
  ...
  const formatSize = function() {
    const window14 = m_window_default.getWindow();
    return {
      width: window14.innerWidth,
      height: window14.innerHeight
    };
  };
...
var getMachineTimezoneName2 = () => globalCache.timezones.memo("localTimezone", (() => date_default2.getMachineTimezoneName()));
...
function readThemeMarker() {
  ...
  let result;
  try {
    result = window4.getComputedStyle(element.get(0)).fontFamily;
    if (!result) {
      return null;
    }
...
function _attachCssClasses(element, themeName) {
  ...
  !(function() {
    const pixelRatio = hasWindow() && window4.devicePixelRatio;
...
var calculatePosition = function(what, options) {
  ...
  let of = renderer_default(options.of).length && options.of || window6;
...
function setupPosition($element, config) {
  ...
  const win = renderer_default(window7);
  let left = 0;
  let top = 0;
...
var INTERNAL_USAGE_ID = "fXSLnRQQaaWnfu5UNZuJZg";
...
var nativeXMLHttpRequest = {
  getXhr: () => new window11.XMLHttpRequest()
};
...
var getRequestOptions = function(options, headers) {
  ...
  let url = options.url || window12.location.href;
...
var isCrossDomain = function(url) {
  ...
  originAnchor.href = window12.location.href;
  try {
    urlAnchor.href = url;
...
var sendRequest = function(options) {
  ...
  if (callbackName) {
    window13[callbackName] = function(data2) {
...
var format_helper_default = dependency_injector_default({
  format: function(value2, format2) {
    ...
    if (isDate(value2)) {
      return date_default.format(value2, format2);
    }
  },
  ...
  _normalizeFormat: function(format2) {
    ...
    return function(date) {
      return format2.map((function(formatPart) {
        return date_default.format(date, formatPart);
      })).join(" ");
    };
  },
    ...
    if (dateDifferences.month && dateDifferences.day) {
      if (intervalFormat) {
        const monthDayFormatter = function(date) {
          return date_default.getMonthNames("abbreviated")[date.getMonth()] + " " + date_default.format(date, "day");
        };
    ...
    if (dateDifferences.day) {
      if (intervalFormat) {
        ...
        const dayFormatter = function(date) {
          return date_default.format(date, "dayofweek") + ", " + date_default.format(date, "day");
        };
  ...
  getDateFormatByTicks: function(ticks) {
    ...
    let i;
    if (ticks.length > 1) {
      maxDiff = date_default2.getDatesDifferences(ticks[0], ticks[1]);
      for (i = 1; i < ticks.length - 1; i++) {
        currentDiff = date_default2.getDatesDifferences(ticks[i], ticks[i + 1]);
  ...
  getDateFormatByTickInterval: function(startValue, endValue, tickInterval) {
    ...
    const dateDifferences = date_default2.getDatesDifferences(startValue, endValue);
    ...
    dateUnitInterval = date_default2.getDateUnitInterval(dateDifferences);
    correctDateDifferences(dateDifferences, dateUnitInterval, true);
    dateUnitInterval = date_default2.getDateUnitInterval(tickInterval || "second");
...
var m_utils_default = {
  ...
  getPixelRatio: (window14) => window14.devicePixelRatio || 1,
...
//# sourceMappingURL=chunk-7KSLWRUY.js.map
