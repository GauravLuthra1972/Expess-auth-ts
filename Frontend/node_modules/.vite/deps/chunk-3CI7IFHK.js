...
var errorMessageFromXhr = (function() {
  ...
  let unloading;
  ready((() => {
    const window5 = getWindow();
    dom_adapter_default.listen(window5, "beforeunload", (() => {
      unloading = true;
    }));
  }));
...
function insert(keyInfo, array, data2, index, isBatch, logError, skipCopying) {
  let keyValue;
  const keyExpr = keyInfo.key();
...
[{
  ...
  initRender.prototype[propName] = function(value) {
    ...
    const window5 = getWindowByElement(this[0]);
    if (void 0 === value) {
...
//# sourceMappingURL=chunk-3CI7IFHK.js.map
